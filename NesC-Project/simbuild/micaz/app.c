...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7fc249bce020, const void *arg_0x7fc249bce320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7fc249b465e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fc2498e93a0), 
int (*key_eq_fn)(void *arg_0x7fc2498e9b70, void *arg_0x7fc2498e9e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fc2496d6c00, int arg_0x7fc2496d6e80);
static double RandomUniform(void );
...
# 20 "lib/modules/../../includes/tcpacket.h"
enum tcp_flags {
  DATA = 0, 
  ACK = 1, 
  SYN = 2, 
...
typedef uint32_t NeighborDiscoveryP__Neighbors__t;
...
typedef uint32_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__t;
typedef /*NeighborDiscoveryC.Neighbors*/HashmapC__0__t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__t;
typedef TMilli DistanceVectorRoutingP__DVRTimer__precision_tag;
typedef sendInfo /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t;
typedef sendInfo */*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t;
typedef TMilli /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__precision_tag;
typedef sendInfo /*DistanceVectorRoutingC.SimpleSendC.PoolC*/PoolC__2__pool_t;
typedef /*DistanceVectorRoutingC.SimpleSendC.PoolC*/PoolC__2__pool_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t;
typedef /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__t;
typedef sendInfo */*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue_t;
typedef /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__t;
typedef TMilli TransportP__TransmissionTimer__precision_tag;
typedef uint8_t TransportP__SocketMap__t;
typedef sendInfo /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Pool__t;
typedef sendInfo */*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__t;
typedef TMilli /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__precision_tag;
typedef sendInfo /*TransportC.SimpleSendC.PoolC*/PoolC__3__pool_t;
typedef /*TransportC.SimpleSendC.PoolC*/PoolC__3__pool_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool_t;
typedef /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__Pool__t;
typedef sendInfo */*TransportC.SimpleSendC.QueueC*/QueueC__3__queue_t;
typedef /*TransportC.SimpleSendC.QueueC*/QueueC__3__queue_t /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__t;
...
typedef uint8_t ClientP__ConnectionMap__t;
typedef TMilli ClientP__ClientTimer__precision_tag;
typedef sendInfo /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Pool__t;
typedef sendInfo */*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__t;
typedef TMilli /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__precision_tag;
typedef sendInfo /*ClientC.SimpleSendC.PoolC*/PoolC__4__pool_t;
typedef /*ClientC.SimpleSendC.PoolC*/PoolC__4__pool_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool_t;
typedef /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__Pool__t;
typedef sendInfo */*ClientC.SimpleSendC.QueueC*/QueueC__4__queue_t;
typedef /*ClientC.SimpleSendC.QueueC*/QueueC__4__queue_t /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__t;
typedef uint8_t /*ClientC.HashmapC*/HashmapC__2__t;
typedef /*ClientC.HashmapC*/HashmapC__2__t /*ClientC.HashmapC*/HashmapC__2__Hashmap__t;
typedef uint8_t ChatP__connections__t;
typedef TMilli ChatP__ChatTimer__precision_tag;
...
typedef /*ChatC.SimpleSendC.PoolC*/PoolC__5__pool_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool_t;
typedef /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__Pool__t;
...
typedef uint8_t /*ChatC.HashmapC*/HashmapC__3__t;
typedef /*ChatC.HashmapC*/HashmapC__3__t /*ChatC.HashmapC*/HashmapC__3__Hashmap__t;
...
static void Node__CommandHandler__chat(char *msg);
#line 4
...
static void Node__CommandHandler__setTestClient(uint8_t dest, uint8_t srcPort, uint8_t destPort, uint16_t payload);
#line 8
...
static uint16_t NeighborDiscoveryP__NeighborDiscovery__Neighbors_num(void );
#line 4
static error_t NeighborDiscoveryP__NeighborDiscovery__start(void );


static uint32_t *NeighborDiscoveryP__NeighborDiscovery__Neighbors_list(void );
...
static /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__get(uint32_t key);
#line 12
static void /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__remove(uint32_t key);
#line 11
static void /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__insert(uint32_t key, /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__t input);





static uint32_t */*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__getKeys(void );
#line 14
static bool /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__contains(uint32_t key);

static uint16_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__size(void );
...
# 4 "lib/interfaces/SimpleSend.nc"
static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__SimpleSend__send(pack msg, uint16_t dest);
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
static void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__runTask(void );
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__fired(void );
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
static void /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 96
message_t * msg, 
...
static 
#line 94
/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__t * 


/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__get(void );
#line 61
static bool /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__empty(void );
#line 89
static error_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__put(
#line 85
/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__t * newVal);
# 62 "/opt/tinyos-main/tos/interfaces/Init.nc"
static error_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Init__init(void );
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__t  

/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__head(void );
#line 97
static error_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__enqueue(
#line 93
/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__t  newVal);
#line 72
static uint8_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__maxSize(void );
#line 88
static 
#line 86
/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__t  

/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__dequeue(void );
#line 50
static bool /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__empty(void );
#line 65
static uint8_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__size(void );
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void TransportP__TransmissionTimer__fired(void );
...
#line 149
static uint32_t TransportP__Transport__getConnectionDest(socket_t fd);
#line 74
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
static void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask__runTask(void );
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__fired(void );
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
static void /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(
#line 96
message_t * msg, 
...
static error_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__Pool__put(
#line 85
/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__Pool__t * newVal);
# 62 "/opt/tinyos-main/tos/interfaces/Init.nc"
static error_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__Init__init(void );
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__t  

/*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__head(void );
...
/*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__dequeue(void );
#line 50
static bool /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__empty(void );
# 13 "dataStructures/interfaces/Hashmap.nc"
...
static bool /*TransportC.SocketMap*/HashmapC__1__Hashmap__contains(uint32_t key);
# 7 "lib/interfaces/Client.nc"
static void ClientP__Client__startClient(uint8_t dest, uint8_t srcPort, uint8_t destPort, uint16_t transfer);
#line 6
static void ClientP__Client__startServer(uint8_t port);

static void ClientP__Client__closeClient(uint8_t srcPort, uint8_t destPort, uint8_t dest);
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void ClientP__ClientTimer__fired(void );
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
static void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask__runTask(void );
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__fired(void );
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
static void /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__Send__sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
static error_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__Pool__put(
#line 85
/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__Pool__t * newVal);
# 62 "/opt/tinyos-main/tos/interfaces/Init.nc"
static error_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__Init__init(void );
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__t  

/*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__head(void );
...
/*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__dequeue(void );
#line 50
static bool /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__empty(void );
# 13 "dataStructures/interfaces/Hashmap.nc"
static /*ClientC.HashmapC*/HashmapC__2__Hashmap__t /*ClientC.HashmapC*/HashmapC__2__Hashmap__get(uint32_t key);
#line 12
static void /*ClientC.HashmapC*/HashmapC__2__Hashmap__remove(uint32_t key);
#line 11
static void /*ClientC.HashmapC*/HashmapC__2__Hashmap__insert(uint32_t key, /*ClientC.HashmapC*/HashmapC__2__Hashmap__t input);
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static void ChatP__ChatTimer__fired(void );
# 7 "lib/interfaces/Chat.nc"
static void ChatP__Chat__chat(char *msg);
#line 6
static void ChatP__Chat__startChatServer(void );
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
...
error_t error);
# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
static error_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__Pool__put(
#line 85
/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__Pool__t * newVal);
# 62 "/opt/tinyos-main/tos/interfaces/Init.nc"
static error_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__Init__init(void );
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
...
# 7 "lib/interfaces/Client.nc"
static void Node__Client__startClient(uint8_t dest, uint8_t srcPort, uint8_t destPort, uint16_t transfer);
#line 6
static void Node__Client__startServer(uint8_t port);

static void Node__Client__closeClient(uint8_t srcPort, uint8_t destPort, uint8_t dest);
# 7 "lib/interfaces/Chat.nc"
static void Node__Chat__chat(char *msg);
#line 6
static void Node__Chat__startChatServer(void );
# 143 "Node.nc"
...
static inline void Node__CommandHandler__chat(char *msg);
# 97 "/opt/tinyos-main/tos/interfaces/Pool.nc"
static 
#line 94
...
static void CommandHandlerP__CommandHandler__chat(char *msg);
#line 4
...
static void CommandHandlerP__CommandHandler__setTestClient(uint8_t dest, uint8_t srcPort, uint8_t destPort, uint16_t payload);
#line 8
...
#line 14
static bool NeighborDiscoveryP__Neighbors__contains(uint32_t key);
...
# 21 "lib/modules/NeighborDiscoveryP.nc"
...
#line 72
static inline uint32_t *NeighborDiscoveryP__NeighborDiscovery__Neighbors_list(void );



static inline uint16_t NeighborDiscoveryP__NeighborDiscovery__Neighbors_num(void );
...
enum /*NeighborDiscoveryC.SimpleSendC.SimpleSendP*/SimpleSendP__0____nesc_unnamed4345 {
#line 74
...
uint16_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__HASH_MAX_SIZE[1000];


uint16_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[1000];




#line 20
typedef struct /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hashmapEntry {
  uint32_t key;
  /*NeighborDiscoveryC.Neighbors*/HashmapC__0__t value;
} /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hashmapEntry;

/*NeighborDiscoveryC.Neighbors*/HashmapC__0__hashmapEntry /*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[1000][20];
uint32_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[1000][20];
uint16_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[1000];


static inline uint32_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hash2(uint32_t k);


static inline uint32_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hash3(uint32_t k);



static inline uint32_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hash(uint32_t k, uint32_t i);



static void /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__insert(uint32_t k, /*NeighborDiscoveryC.Neighbors*/HashmapC__0__t input);
#line 76
static inline void /*NeighborDiscoveryC.Neighbors*/HashmapC__0__removeFromKeyList(uint32_t k);
#line 109
static inline void /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__remove(uint32_t k);
#line 130
static /*NeighborDiscoveryC.Neighbors*/HashmapC__0__t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__get(uint32_t k);
#line 143
static inline bool /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__contains(uint32_t k);
#line 166
static inline uint32_t */*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__getKeys(void );



static inline uint16_t /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__size(void );
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t DistanceVectorRoutingP__Random__rand16(void );
# 84 "lib/interfaces/Transport.nc"
static error_t DistanceVectorRoutingP__Transport__receive(pack *package);
# 8 "lib/interfaces/NeighborDiscovery.nc"
static uint16_t DistanceVectorRoutingP__NeighborDiscovery__Neighbors_num(void );
#line 7
static uint32_t *DistanceVectorRoutingP__NeighborDiscovery__Neighbors_list(void );
# 4 "lib/interfaces/SimpleSend.nc"
...
# 209 "lib/modules/DistanceVectorRoutingP.nc"
#line 204
typedef struct DistanceVectorRoutingP____nesc_unnamed4354 {
  uint8_t dest;
  uint8_t nextHop;
  uint8_t dist;
  uint8_t ttl;
...
DistanceVectorRoutingP__Route DistanceVectorRoutingP__routingTable[1000][25];
...
static void DistanceVectorRoutingP__addRoute(uint8_t dest, uint8_t nextHop, uint8_t dist, uint8_t ttl);
...
static 
#line 94
/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t * 


/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__get(void );
#line 61
static bool /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__empty(void );
#line 89
static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__put(
#line 85
/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t * newVal);
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  

/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__head(void );
#line 97
static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__enqueue(
#line 93
/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  newVal);
#line 88
static 
#line 86
/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  

/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__dequeue(void );
#line 50
static bool /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__empty(void );
# 126 "/opt/tinyos-main/tos/interfaces/Packet.nc"
static 
#line 123
void * 
...
/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Random__rand16(void );
# 67 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__postTask(void );
# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static bool /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__isRunning(void );
#line 73
static void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__startOneShot(uint32_t dt);
# 74 "lib/modules/SimpleSendP.nc"
enum /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1____nesc_unnamed4355 {
#line 74
  SimpleSendP__1__sendBufferTask = 10U
};
#line 74
typedef int /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1____nesc_sillytask_sendBufferTask[/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask];
#line 31
bool /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[1000];
message_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[1000];

static inline error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__send(uint16_t src, uint16_t dest, pack *message);



static void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__postSendTask(void );
...
static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__SimpleSend__send(pack msg, uint16_t dest);
#line 74
static inline void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__runTask(void );
#line 103
static inline void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__fired(void );
#line 118
static inline error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__send(uint16_t src, uint16_t dest, pack *message);
#line 150
static inline void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__sendDone(message_t *msg, error_t error);
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static void /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main/tos/interfaces/Send.nc"
static error_t /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-main/tos/interfaces/AMPacket.nc"
static void /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-main/tos/system/AMQueueEntryP.nc"
static inline error_t /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 60 "/opt/tinyos-main/tos/system/PoolP.nc"
uint8_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[1000];
uint8_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[1000];
/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t * /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[1000][20];
/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[1000][20];

static inline error_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Init__init(void );
...
static inline bool /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__empty(void );
#line 88
static inline /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t */*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__get(void );
#line 103
static inline error_t /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__put(/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t *newVal);
# 48 "/opt/tinyos-main/tos/system/QueueC.nc"
/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue_t  /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue[1000][20];
uint8_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[1000];
uint8_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail[1000];
uint8_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[1000];

static inline bool /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__empty(void );
...
static inline uint8_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__size(void );



static inline uint8_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__maxSize(void );



static inline /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__head(void );



static void /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__printQueue(void );
#line 89
static inline /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__dequeue(void );
#line 101
static inline error_t /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__enqueue(/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue_t newVal);
# 136 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static uint32_t TransportP__TransmissionTimer__getNow(void );
#line 98
static bool TransportP__TransmissionTimer__isOneShot(void );
#line 64
static void TransportP__TransmissionTimer__startPeriodic(uint32_t dt);
...
static void TransportP__TransmissionTimer__startOneShot(uint32_t dt);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t TransportP__Random__rand16(void );
# 6 "lib/interfaces/DistanceVectorRouting.nc"
static void TransportP__DistanceVectorRouting__routePacket(pack *myMsg);
# 13 "dataStructures/interfaces/Hashmap.nc"
...
static bool TransportP__SocketMap__contains(uint32_t key);
# 22 "lib/modules/TransportP.nc"
pack TransportP__packet[1000];
tcp_pack TransportP__tcpPack[1000];
bool TransportP__ports[1000][256];
socket_store_t TransportP__sockets[1000][MAX_NUM_OF_SOCKETS];

static inline void TransportP__makePack(pack *Package, uint16_t src, uint16_t dest, uint16_t TTL, uint16_t protocol, uint16_t seq, void *payload, uint8_t length);
static inline uint32_t TransportP__min(uint32_t a, uint32_t b);
static inline uint32_t TransportP__max(uint32_t a, uint32_t b);
static inline uint32_t TransportP__absolute(uint32_t a, uint32_t b);
static inline void TransportP__addCon(uint8_t fd, uint8_t conn);
static uint8_t TransportP__findSocket(uint8_t src, uint8_t srcPort, uint8_t dest, uint8_t destPort);
static uint16_t TransportP__getRreadable(uint8_t fd);
static uint16_t TransportP__getSDatainFlight(uint8_t fd);
static uint16_t TransportP__getSendBufferOccupied(uint8_t fd);

static inline uint16_t TransportP__getSendBufferAvailable(uint8_t fd);
static uint16_t TransportP__getReceiveBufferAvailable(uint8_t fd);
static inline uint8_t TransportP__calAdv(uint8_t fd);
static inline uint8_t TransportP__calEFF(uint8_t fd);
static uint8_t TransportP__calCong(uint8_t fd);
...
static inline bool TransportP__fastTra(uint8_t fd, uint16_t ack);
static inline void TransportP__readData(uint8_t fd, tcp_pack *packet);
static void TransportP__resetSocket(uint8_t fd);
static inline uint8_t TransportP__dupSocket(uint8_t fd, uint16_t addr, uint8_t port);
...
static inline void TransportP__TransmissionTimer__fired(void );
#line 131
static socket_t TransportP__Transport__socket(void );
#line 157
static error_t TransportP__Transport__bind(socket_t fd, socket_addr_t *addr);
...
static error_t TransportP__Transport__listen(socket_t fd);
#line 586
static inline uint32_t TransportP__Transport__getConnectionDest(socket_t fd);
...
static inline bool TransportP__fastTra(uint8_t fd, uint16_t ack);
#line 836
static inline void TransportP__readData(uint8_t fd, tcp_pack *tcp_rcvd);
#line 865
static void TransportP__resetSocket(uint8_t fd);
#line 904
static inline uint8_t TransportP__dupSocket(uint8_t fd, uint16_t addr, uint8_t port);
# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
static error_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Pool__put(
#line 85
/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Pool__t * newVal);
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__t  

/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__head(void );
...
/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__dequeue(void );
#line 50
static bool /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__empty(void );
# 126 "/opt/tinyos-main/tos/interfaces/Packet.nc"
static 
#line 123
void * 
...
/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Random__rand16(void );
# 67 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
static error_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask__postTask(void );
# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static bool /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__isRunning(void );
#line 73
static void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__startOneShot(uint32_t dt);
# 74 "lib/modules/SimpleSendP.nc"
enum /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2____nesc_unnamed4356 {
#line 74
  SimpleSendP__2__sendBufferTask = 11U
};
#line 74
typedef int /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2____nesc_sillytask_sendBufferTask[/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask];
#line 31
bool /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy[1000];
message_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt[1000];

static inline error_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__send(uint16_t src, uint16_t dest, pack *message);



static void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__postSendTask(void );
#line 74
static inline void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask__runTask(void );
#line 103
static inline void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__fired(void );
#line 118
static inline error_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__send(uint16_t src, uint16_t dest, pack *message);
#line 150
static inline void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__AMSend__sendDone(message_t *msg, error_t error);
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static void /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main/tos/interfaces/Send.nc"
static error_t /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-main/tos/interfaces/AMPacket.nc"
static void /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-main/tos/system/AMQueueEntryP.nc"
static inline error_t /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(message_t *m, error_t err);
# 60 "/opt/tinyos-main/tos/system/PoolP.nc"
uint8_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[1000];
uint8_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__index[1000];
/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool_t * /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__queue[1000][20];
/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool[1000][20];

static inline error_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__Init__init(void );
#line 103
static inline error_t /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__Pool__put(/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool_t *newVal);
# 48 "/opt/tinyos-main/tos/system/QueueC.nc"
/*TransportC.SimpleSendC.QueueC*/QueueC__3__queue_t  /*TransportC.SimpleSendC.QueueC*/QueueC__3__queue[1000][20];
uint8_t /*TransportC.SimpleSendC.QueueC*/QueueC__3__head[1000];

uint8_t /*TransportC.SimpleSendC.QueueC*/QueueC__3__size[1000];

static inline bool /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__empty(void );
#line 69
static inline /*TransportC.SimpleSendC.QueueC*/QueueC__3__queue_t /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__head(void );



static inline void /*TransportC.SimpleSendC.QueueC*/QueueC__3__printQueue(void );
#line 89
static inline /*TransportC.SimpleSendC.QueueC*/QueueC__3__queue_t /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__dequeue(void );
# 15 "dataStructures/modules/HashmapC.nc"
...
#line 143
static inline bool /*TransportC.SocketMap*/HashmapC__1__Hashmap__contains(uint32_t k);
# 13 "dataStructures/interfaces/Hashmap.nc"
static ClientP__ConnectionMap__t ClientP__ConnectionMap__get(uint32_t key);
#line 12
static void ClientP__ConnectionMap__remove(uint32_t key);
#line 11
static void ClientP__ConnectionMap__insert(uint32_t key, ClientP__ConnectionMap__t input);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t ClientP__Random__rand16(void );
# 148 "lib/interfaces/Transport.nc"
static error_t ClientP__Transport__listen(socket_t fd);
#line 43
static error_t ClientP__Transport__bind(socket_t fd, socket_addr_t *addr);
#line 29
static socket_t ClientP__Transport__socket(void );
#line 101
static uint16_t ClientP__Transport__read(socket_t fd, uint8_t *buff, uint16_t bufflen);
#line 115
static error_t ClientP__Transport__connect(socket_t fd, socket_addr_t *addr);
#line 57
static socket_t ClientP__Transport__accept(socket_t fd);
#line 74
static uint16_t ClientP__Transport__write(socket_t fd, uint8_t *buff, uint16_t bufflen);
#line 126
static error_t ClientP__Transport__close(socket_t fd);
# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static bool ClientP__ClientTimer__isRunning(void );
#line 64
static void ClientP__ClientTimer__startPeriodic(uint32_t dt);
# 31 "lib/modules/ClientP.nc"
#line 24
typedef struct ClientP__server_t {
  uint8_t sockfd;
...
#line 33
typedef struct ClientP__client_t {
  uint8_t sockfd;
  uint16_t bytesWritten;
...
ClientP__server_t ClientP__server[1000][MAX_NUM_OF_SOCKETS];
ClientP__client_t ClientP__client[1000][MAX_NUM_OF_SOCKETS];
uint8_t ClientP__numServers[1000];
uint8_t ClientP__numClients[1000];

static inline void ClientP__handleServer(void );
static inline void ClientP__handleClient(void );
static uint16_t ClientP__serverOccupied(uint8_t x);
static inline uint16_t ClientP__serverAvailable(uint8_t x);
static uint16_t ClientP__clientOccupied(uint8_t x);
static inline uint16_t ClientP__clientAvailable(uint8_t x);
static inline void ClientP__zeroClient(uint8_t x);

static inline uint16_t ClientP__min(uint16_t a, uint16_t b);

static inline void ClientP__Client__startServer(uint8_t port);
#line 90
static inline void ClientP__Client__startClient(uint8_t dest, uint8_t srcPort, uint8_t destPort, uint16_t transfer);
#line 145
static inline void ClientP__Client__closeClient(uint8_t srcPort, uint8_t destPort, uint8_t dest);
#line 158
static inline void ClientP__ClientTimer__fired(void );
...
static inline uint16_t ClientP__min(uint16_t a, uint16_t b);
# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
static error_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Pool__put(
#line 85
/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Pool__t * newVal);
# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
static 
#line 78
/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__t  

/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__head(void );
...
/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__dequeue(void );
#line 50
static bool /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__empty(void );
# 126 "/opt/tinyos-main/tos/interfaces/Packet.nc"
static 
#line 123
void * 
...
/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static error_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Random__rand16(void );
# 67 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
static error_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask__postTask(void );
# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static bool /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__isRunning(void );
#line 73
static void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__startOneShot(uint32_t dt);
# 74 "lib/modules/SimpleSendP.nc"
enum /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3____nesc_unnamed4357 {
#line 74
  SimpleSendP__3__sendBufferTask = 12U
};
#line 74
typedef int /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3____nesc_sillytask_sendBufferTask[/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask];
#line 31
bool /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy[1000];
message_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt[1000];

static inline error_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__send(uint16_t src, uint16_t dest, pack *message);



static void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__postSendTask(void );
#line 74
static inline void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask__runTask(void );
#line 103
static inline void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__fired(void );
#line 118
static inline error_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__send(uint16_t src, uint16_t dest, pack *message);
#line 150
static inline void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__AMSend__sendDone(message_t *msg, error_t error);
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
static void /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main/tos/interfaces/Send.nc"
static error_t /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-main/tos/interfaces/AMPacket.nc"
static void /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-main/tos/system/AMQueueEntryP.nc"
static inline error_t /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__Send__sendDone(message_t *m, error_t err);
# 60 "/opt/tinyos-main/tos/system/PoolP.nc"
uint8_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[1000];
uint8_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__index[1000];
/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool_t * /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__queue[1000][20];
/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool[1000][20];

static inline error_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__Init__init(void );
#line 103
static inline error_t /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__Pool__put(/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool_t *newVal);
# 48 "/opt/tinyos-main/tos/system/QueueC.nc"
/*ClientC.SimpleSendC.QueueC*/QueueC__4__queue_t  /*ClientC.SimpleSendC.QueueC*/QueueC__4__queue[1000][20];
uint8_t /*ClientC.SimpleSendC.QueueC*/QueueC__4__head[1000];

uint8_t /*ClientC.SimpleSendC.QueueC*/QueueC__4__size[1000];

static inline bool /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__empty(void );
#line 69
static inline /*ClientC.SimpleSendC.QueueC*/QueueC__4__queue_t /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__head(void );



static inline void /*ClientC.SimpleSendC.QueueC*/QueueC__4__printQueue(void );
#line 89
static inline /*ClientC.SimpleSendC.QueueC*/QueueC__4__queue_t /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__dequeue(void );
# 15 "dataStructures/modules/HashmapC.nc"
uint16_t /*ClientC.HashmapC*/HashmapC__2__HASH_MAX_SIZE[1000];


uint16_t /*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[1000];




#line 20
typedef struct /*ClientC.HashmapC*/HashmapC__2__hashmapEntry {
  uint32_t key;
  /*ClientC.HashmapC*/HashmapC__2__t value;
} /*ClientC.HashmapC*/HashmapC__2__hashmapEntry;

/*ClientC.HashmapC*/HashmapC__2__hashmapEntry /*ClientC.HashmapC*/HashmapC__2__map[1000][20];
uint32_t /*ClientC.HashmapC*/HashmapC__2__keys[1000][20];
uint16_t /*ClientC.HashmapC*/HashmapC__2__numofVals[1000];


static inline uint32_t /*ClientC.HashmapC*/HashmapC__2__hash2(uint32_t k);


static inline uint32_t /*ClientC.HashmapC*/HashmapC__2__hash3(uint32_t k);



static inline uint32_t /*ClientC.HashmapC*/HashmapC__2__hash(uint32_t k, uint32_t i);



static void /*ClientC.HashmapC*/HashmapC__2__Hashmap__insert(uint32_t k, /*ClientC.HashmapC*/HashmapC__2__t input);
#line 76
static inline void /*ClientC.HashmapC*/HashmapC__2__removeFromKeyList(uint32_t k);
#line 109
static inline void /*ClientC.HashmapC*/HashmapC__2__Hashmap__remove(uint32_t k);
#line 130
static inline /*ClientC.HashmapC*/HashmapC__2__t /*ClientC.HashmapC*/HashmapC__2__Hashmap__get(uint32_t k);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
static uint16_t ChatP__Random__rand16(void );
# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
static bool ChatP__ChatTimer__isRunning(void );
#line 64
static void ChatP__ChatTimer__startPeriodic(uint32_t dt);
# 148 "lib/interfaces/Transport.nc"
static error_t ChatP__Transport__listen(socket_t fd);
#line 43
static error_t ChatP__Transport__bind(socket_t fd, socket_addr_t *addr);
#line 29
static socket_t ChatP__Transport__socket(void );
#line 101
static uint16_t ChatP__Transport__read(socket_t fd, uint8_t *buff, uint16_t bufflen);
#line 115
static error_t ChatP__Transport__connect(socket_t fd, socket_addr_t *addr);
#line 57
static socket_t ChatP__Transport__accept(socket_t fd);
#line 149
static uint32_t ChatP__Transport__getConnectionDest(socket_t fd);
#line 74
static uint16_t ChatP__Transport__write(socket_t fd, uint8_t *buff, uint16_t bufflen);
# 34 "lib/modules/ChatP.nc"
enum ChatP__conn_type {
  ChatP__OFF, 
  ChatP__SERVER, 
  ChatP__CLIENT
};

enum ChatP__msg_type {
  ChatP__HELLO, 
  ChatP__MSG, 
  ChatP__WHISPER, 
  ChatP__LISTUSR
...
#line 57
#line 47
typedef struct ChatP__chat_conn_t {
  uint8_t readFd;
  uint8_t writeFd;
  uint8_t sendRead;
  uint8_t sendWritten;
...
#line 59
typedef struct ChatP__chat_app_t {
  enum ChatP__conn_type state;
  uint8_t numOfConns;
  uint8_t listenSockFd;
  ChatP__chat_conn_t connections[5];
} ChatP__chat_app_t;

ChatP__chat_app_t ChatP__chatApp[1000];


static bool ChatP__startsWith(char *a, char *b);
static inline void ChatP__getCommand(uint8_t index);
static uint16_t ChatP__getRBufferAvailable(uint8_t i);


static uint16_t ChatP__getSBufferOccupied(uint8_t i);

static inline void ChatP__sendHello(uint8_t clientPort);




static inline void ChatP__ChatTimer__fired(void );
#line 179
static inline void ChatP__Chat__startChatServer(void );
#line 203
static inline void ChatP__Chat__chat(char *message);
#line 257
static bool ChatP__startsWith(char *a, char *b);
#line 275
static inline void ChatP__getCommand(uint8_t index);
...
# 74 "lib/modules/SimpleSendP.nc"
enum /*ChatC.SimpleSendC.SimpleSendP*/SimpleSendP__4____nesc_unnamed4358 {
#line 74
...
# 60 "/opt/tinyos-main/tos/system/PoolP.nc"
uint8_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[1000];
uint8_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__index[1000];
/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool_t * /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__queue[1000][20];
/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool[1000][20];

static inline error_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__Init__init(void );
#line 103
static inline error_t /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__Pool__put(/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool_t *newVal);
# 48 "/opt/tinyos-main/tos/system/QueueC.nc"
...
#line 20
typedef struct /*ChatC.HashmapC*/HashmapC__3__hashmapEntry {
  uint32_t key;
  /*ChatC.HashmapC*/HashmapC__3__t value;
} /*ChatC.HashmapC*/HashmapC__3__hashmapEntry;
...
#line 11
  /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__insert(key, input);
#line 11
}
#line 11
# 336 "lib/modules/DistanceVectorRoutingP.nc"
static inline void DistanceVectorRoutingP__DistanceVectorRouting__handleNeighborFound(void )
#line 336
{
...
#line 37
{
  return (/*NeighborDiscoveryC.Neighbors*/HashmapC__0__hash2(k) + i * /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hash3(k)) % /*NeighborDiscoveryC.Neighbors*/HashmapC__0__HASH_MAX_SIZE[sim_node()];
}
...
#line 144
  ...
  do {
      j = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hash(k, i);
      if (/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].key == k) {
        return TRUE;
        }
#line 155
      i++;
  ...
  while (
#line 156
  i < /*NeighborDiscoveryC.Neighbors*/HashmapC__0__HASH_MAX_SIZE[sim_node()]);
  return FALSE;
}

# 14 "dataStructures/interfaces/Hashmap.nc"
inline static bool NeighborDiscoveryP__Neighbors__contains(uint32_t key){
#line 14
  unsigned char __nesc_result;
#line 14

#line 14
  __nesc_result = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__contains(key);
#line 14
...
#line 31
  if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING && __nesc_ntoh_uint8(myMsg->TTL.nxdata) > 0) {
      ...
      sim_log_debug(137U, NEIGHBOR_CHANNEL, "Neighbor Discovery PING!\n");
    }
  else {
#line 37
    if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PINGREPLY && __nesc_ntoh_uint16(myMsg->dest.nxdata) == 0) {
        sim_log_debug(138U, NEIGHBOR_CHANNEL, "Neighbor Discovery PINGREPLY! Found Neighbor %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
        if (!NeighborDiscoveryP__Neighbors__contains(__nesc_ntoh_uint16(myMsg->src.nxdata))) {
            NeighborDiscoveryP__Neighbors__insert(__nesc_ntoh_uint16(myMsg->src.nxdata), 5);
...
#line 5
# 276 "lib/modules/DistanceVectorRoutingP.nc"
static inline void DistanceVectorRoutingP__DistanceVectorRouting__handleDV(pack *myMsg)
#line 276
{
  uint16_t i;
          ...
          if (receivedRoutes[i].dest == DistanceVectorRoutingP__routingTable[sim_node()][j].dest) {
              ...
              if (receivedRoutes[i].nextHop != 0) {
                  if (DistanceVectorRoutingP__routingTable[sim_node()][j].nextHop == __nesc_ntoh_uint16(myMsg->src.nxdata)) {
                      DistanceVectorRoutingP__routingTable[sim_node()][j].dist = receivedRoutes[i].dist + 1 < 18 ? receivedRoutes[i].dist + 1 : 18;
                      DistanceVectorRoutingP__routingTable[sim_node()][j].ttl = 4;
                    }
                  else {
#line 295
                    if (receivedRoutes[i].dist + 1 < 18 && receivedRoutes[i].dist + 1 < DistanceVectorRoutingP__routingTable[sim_node()][j].dist) {
                        DistanceVectorRoutingP__routingTable[sim_node()][j].nextHop = __nesc_ntoh_uint16(myMsg->src.nxdata);
                        DistanceVectorRoutingP__routingTable[sim_node()][j].dist = receivedRoutes[i].dist + 1;
                        DistanceVectorRoutingP__routingTable[sim_node()][j].ttl = 4;
                      }
                    }
                }

              if (DistanceVectorRoutingP__routingTable[sim_node()][j].nextHop == receivedRoutes[i].nextHop && DistanceVectorRoutingP__routingTable[sim_node()][j].dist == receivedRoutes[i].dist && DistanceVectorRoutingP__routingTable[sim_node()][j].dist != 18) {
                  DistanceVectorRoutingP__routingTable[sim_node()][j].ttl = 4;
                }
              routePresent = TRUE;
              break;
      ...
      if (!routePresent && DistanceVectorRoutingP__numRoutes[sim_node()] != 25 && receivedRoutes[i].nextHop != 0 && receivedRoutes[i].dist != 18) {
          DistanceVectorRoutingP__addRoute(receivedRoutes[i].dest, __nesc_ntoh_uint16(myMsg->src.nxdata), receivedRoutes[i].dist + 1, 4);
          routesAdded = TRUE;
        }
      routePresent = FALSE;
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fc2493c6e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fc2493c6e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fc2493c6e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 166
{
  return /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()];
}
...
#line 17
  __nesc_result = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__getKeys();
#line 17
...
inline static uint32_t *DistanceVectorRoutingP__NeighborDiscovery__Neighbors_list(void ){
#line 7
  unsigned int *__nesc_result;
#line 7

#line 7
  __nesc_result = NeighborDiscoveryP__NeighborDiscovery__Neighbors_list();
#line 7
...
#line 170
{
  return /*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[sim_node()];
}
...
#line 16
  __nesc_result = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__size();
#line 16
...
#line 16
# 76 "lib/modules/NeighborDiscoveryP.nc"
static inline uint16_t NeighborDiscoveryP__NeighborDiscovery__Neighbors_num(void )
#line 76
{
  return NeighborDiscoveryP__Neighbors__size();
}

# 8 "lib/interfaces/NeighborDiscovery.nc"
inline static uint16_t DistanceVectorRoutingP__NeighborDiscovery__Neighbors_num(void ){
#line 8
  unsigned short __nesc_result;
#line 8

#line 8
  __nesc_result = NeighborDiscoveryP__NeighborDiscovery__Neighbors_num();
#line 8
...
#line 4
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__SimpleSend__send(msg, dest);
#line 4
...
#line 75
{
  sim_log_debug(212U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()]);
  return /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()] == 0;
}

# 61 "/opt/tinyos-main/tos/interfaces/Pool.nc"
inline static bool /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__empty(void ){
#line 61
  unsigned char __nesc_result;
#line 61

#line 61
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__empty();
#line 61
...
#line 88
{
  if (/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()]) {
      /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool_t *rval = /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[sim_node()][/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()]];

#line 91
      /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[sim_node()][/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()]] = (void *)0;
      /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()]--;
      /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()]++;
      if (/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()] == 20) {
          /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()] = 0;
        }
...
# 97 "/opt/tinyos-main/tos/interfaces/Pool.nc"
inline static /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t * /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__get(void ){
#line 97
  struct sendInfo *__nesc_result;
#line 97

#line 97
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__get();
#line 97
...
#line 61
{
  return /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[sim_node()];
}
...
#line 101
{
  if (/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__size() < /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__maxSize()) {
      sim_log_debug(222U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[sim_node()]);
      /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue[sim_node()][/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail[sim_node()]] = newVal;
      /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail[sim_node()]++;
      if (/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail[sim_node()] == 20) {
#line 106
        /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail[sim_node()] = 0;
        }
#line 107
      /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[sim_node()]++;
      /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__printQueue();
      return SUCCESS;
    }
  else {
      return FAIL;
...
# 97 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__enqueue(/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  newVal){
#line 97
  unsigned char __nesc_result;
#line 97

#line 97
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__enqueue(newVal);
#line 97
...
# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static bool /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
# 73 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__startOneShot(uint32_t dt){
#line 73
...
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
inline static uint16_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Random__rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
# 136 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static uint32_t TransportP__TransmissionTimer__getNow(void ){
#line 136
  unsigned int __nesc_result;
#line 136
...
#line 624
  for (i = 0; i < MAX_NUM_OF_SOCKETS - 1; i++) {
      if (TransportP__sockets[sim_node()][fd - 1].connectionQueue[i] == 0) {
          TransportP__sockets[sim_node()][fd - 1].connectionQueue[i] = conn;
          break;
        }
    }
}
...
# 14 "dataStructures/interfaces/Hashmap.nc"
inline static bool TransportP__SocketMap__contains(uint32_t key){
#line 14
  unsigned char __nesc_result;
#line 14

#line 14
  __nesc_result = /*TransportC.SocketMap*/HashmapC__1__Hashmap__contains(key);
#line 14
...
#line 801
  if (TransportP__sockets[sim_node()][fd - 1].dupAck.seq == ack) {
      TransportP__sockets[sim_node()][fd - 1].dupAck.count++;
      if (TransportP__sockets[sim_node()][fd - 1].dupAck.count == 3) {


          var = TransportP__calCong(fd);
          TransportP__sockets[sim_node()][fd - 1].cwnd = TransportP__max((var >> 1) / 5 * sizeof(nx_uint16_t ), 1);
          TransportP__sockets[sim_node()][fd - 1].cwndRemainder = (var >> 1) % 5 * sizeof(nx_uint16_t ) * TransportP__sockets[sim_node()][fd - 1].cwnd / 5 * sizeof(nx_uint16_t );

          TransportP__sockets[sim_node()][fd - 1].ssthresh = TransportP__calCong(fd);
...
#line 826
    {
      TransportP__sockets[sim_node()][fd - 1].dupAck.seq = ack;
      TransportP__sockets[sim_node()][fd - 1].dupAck.count = 1;
    }
  return FALSE;
}
...
#line 701
{
  ...
  return SOCKET_BUFFER_SIZE - TransportP__getRreadable(fd) - 1;
}
...
#line 706
{
  ...
  return TransportP__sockets[sim_node()][fd - 1].advertisedWindow - TransportP__getSDatainFlight(fd);
}
...
#line 839
  if ((TransportP__getReceiveBufferAvailable(fd) < __nesc_ntoh_uint8(tcp_rcvd->length.nxdata) || TransportP__sockets[sim_node()][fd - 1].nextExpected != __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata)) || __nesc_ntoh_uint8(tcp_rcvd->flags.nxdata) != DATA) {

      return;
    }
  sim_log_debug(250U, TRANSPORT_CHANNEL, "Reading in data with sequence number %u.\n", __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata));
  while (read < __nesc_ntoh_uint8(tcp_rcvd->length.nxdata) && TransportP__getReceiveBufferAvailable(fd) > 0) {
      memcpy(&TransportP__sockets[sim_node()][fd - 1].rcvdBuff[++ TransportP__sockets[sim_node()][fd - 1].lastRcvd % SOCKET_BUFFER_SIZE], payload + read, 1);
      read += 1;
    }
  sim_log_debug(251U, TRANSPORT_CHANNEL, "Last Received %u.\n", TransportP__sockets[sim_node()][fd - 1].lastRcvd);
  TransportP__sockets[sim_node()][fd - 1].nextExpected = TransportP__sockets[sim_node()][fd - 1].lastRcvd + 1;
  sim_log_debug(252U, TRANSPORT_CHANNEL, "Next Expected %u.\n", TransportP__sockets[sim_node()][fd - 1].nextExpected);
  sim_log_debug(253U, TRANSPORT_CHANNEL, "Effective window %u.\n", TransportP__calEFF(fd));
  TransportP__sockets[sim_node()][fd - 1].advertisedWindow = TransportP__calAdv(fd);
  sim_log_debug(254U, TRANSPORT_CHANNEL, "Advertised window %u.\n", TransportP__sockets[sim_node()][fd - 1].advertisedWindow);
  if (TransportP__sockets[sim_node()][fd - 1].advertisedWindow == 0) {
      sim_log_debug(255U, TRANSPORT_CHANNEL, "Setting Timeout. Adv Win. %u.\n", TransportP__sockets[sim_node()][fd - 1].advertisedWindow);
      TransportP__sockets[sim_node()][fd - 1].deadlockAck = TRUE;
      TransportP__sockets[sim_node()][fd - 1].RTO = TransportP__TransmissionTimer__getNow() + 4096;
    }
}
...
#line 246
  ...
  switch (__nesc_ntoh_uint8(tcp_rcvd->flags.nxdata)) {
      case DATA: 
        fd = TransportP__findSocket(TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata));
      switch (TransportP__sockets[sim_node()][fd - 1].state) {
          case SYN_RCVD: 
            sim_log_debug(226U, TRANSPORT_CHANNEL, "CONNECTION ESTABLISHED!\n");
          TransportP__sockets[sim_node()][fd - 1].state = ESTABLISHED;
          case ESTABLISHED: 
            if (TransportP__sockets[sim_node()][fd - 1].deadlockAck && __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata) == TransportP__sockets[sim_node()][fd - 1].nextExpected) {
              TransportP__sockets[sim_node()][fd - 1].deadlockAck = FALSE;
              }


          TransportP__readData(fd, tcp_rcvd);
...
#line 274
      TransportP__calcRTT(fd, __nesc_ntoh_uint16(tcp_rcvd->ack.nxdata));

      switch (TransportP__sockets[sim_node()][fd - 1].state) {
          case SYN_RCVD: 

            sim_log_debug(227U, TRANSPORT_CHANNEL, "ACK received on node %u via port %u from node %u via port %u with seq: %u\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata), __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata));

          TransportP__sockets[sim_node()][fd - 1].state = ESTABLISHED;
          sim_log_debug(228U, TRANSPORT_CHANNEL, "CONNECTION ESTABLISHED!\n");
          return SUCCESS;
          case ESTABLISHED: 

            if (!TransportP__fastTra(fd, __nesc_ntoh_uint16(tcp_rcvd->ack.nxdata))) {
                ...
                switch (TransportP__sockets[sim_node()][fd - 1].cwndStrategy) {
                    ...
                    if (TransportP__calCong(fd) >= TransportP__sockets[sim_node()][fd - 1].ssthresh) {
                        TransportP__sockets[sim_node()][fd - 1].cwndStrategy = AIMD;
                      }
                    break;
                    case AIMD: 

                      if (TransportP__sockets[sim_node()][fd - 1].cwnd < 18) {
          ...
          TransportP__sockets[sim_node()][fd - 1].lastAck = __nesc_ntoh_uint16(tcp_rcvd->ack.nxdata) - 1;
          TransportP__sockets[sim_node()][fd - 1].advertisedWindow = __nesc_ntoh_uint8(tcp_rcvd->advertisedWindow.nxdata);
          return SUCCESS;
          case FIN_WAIT_1: 

            sim_log_debug(229U, TRANSPORT_CHANNEL, "ACK received on node %u via port %u  from node %u via port %u with seq: %u. Going to FIN_WAIT_2.\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata), __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata));

          TransportP__sockets[sim_node()][fd - 1].state = FIN_WAIT_2;
          return SUCCESS;
          case CLOSING: 

            sim_log_debug(230U, TRANSPORT_CHANNEL, "Received last ack. Going to TIME_WAIT.\n");
          TransportP__sockets[sim_node()][fd - 1].state = TIME_WAIT;
          TransportP__sockets[sim_node()][fd - 1].RTO = TransportP__TransmissionTimer__getNow() + 4 * TransportP__sockets[sim_node()][fd - 1].RTT;
          return SUCCESS;
          case LAST_ACK: 

            sim_log_debug(231U, TRANSPORT_CHANNEL, "Received ACK on node %u via port %u from node %u via port %u with seq %u. reseting sockets.\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata), __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata));
          TransportP__resetSocket(fd);
          TransportP__sockets[sim_node()][fd - 1].state = CLOSED;
          sim_log_debug(232U, TRANSPORT_CHANNEL, "CONNECTION CLOSED!\n");
          return SUCCESS;
        }
      break;
      case SYN: 
        id = ((((uint32_t )TOS_NODE_ID << 24) | ((uint32_t )__nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata) << 16)) | ((uint32_t )__nesc_ntoh_uint16(package->src.nxdata) << 8)) | (uint32_t )__nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata);
      if (TransportP__SocketMap__contains(id)) {
          sim_log_debug(233U, TRANSPORT_CHANNEL, "SYN received: failed to insert socket\n");
          return FAIL;
        }

      fd = TransportP__findSocket(TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), 0, 0);
      if (fd == 0) {
        return FAIL;
        }
#line 347
      switch (TransportP__sockets[sim_node()][fd - 1].state) {
          case LISTEN: 
            ...
            newFd = TransportP__dupSocket(fd, __nesc_ntoh_uint16(package->src.nxdata), __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata));
          if (newFd > 0) {
              TransportP__addCon(fd, newFd);

              sim_log_debug(234U, TRANSPORT_CHANNEL, "SYN recieved on node %u via port %u from node %u via port %u with seq %u\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata), __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata));
              TransportP__sockets[sim_node()][newFd - 1].state = SYN_RCVD;
              TransportP__sockets[sim_node()][newFd - 1].lastRead = __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata);
              TransportP__sockets[sim_node()][newFd - 1].lastRcvd = __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata);
              TransportP__sockets[sim_node()][newFd - 1].nextExpected = __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata) + 1;
              TransportP__sendTCPPacket(newFd, SYN_ACK);
              sim_log_debug(235U, TRANSPORT_CHANNEL, "SYN_ACK sent on node %u via port %u to node %u via port %u\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata));
              TransportP__SocketMap__insert(id, newFd);
              return SUCCESS;
            }
        }
...
#line 371
      if (TransportP__sockets[sim_node()][fd - 1].state == SYN_SENT) {
          ...
          sim_log_debug(236U, TRANSPORT_CHANNEL, "SYN_ACK received on node %u via port %u from node %u via port %u\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata));
          ...
          sim_log_debug(237U, TRANSPORT_CHANNEL, "ACK sent on node %u via port %u\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata));
          sim_log_debug(238U, TRANSPORT_CHANNEL, "CONNECTION ESTABLISHED!\n");
          return SUCCESS;
        }
      break;
      case FIN: 
        fd = TransportP__findSocket(TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata));
      sim_log_debug(239U, TRANSPORT_CHANNEL, "FIN received on node %u from port %u by node %u from port %u with seq: %u.\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), src, __nesc_ntoh_uint8(tcp_rcvd->srcPort.nxdata), __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata));
      switch (TransportP__sockets[sim_node()][fd - 1].state) {
          case ESTABLISHED: 

            sim_log_debug(240U, TRANSPORT_CHANNEL, "Going to CLOSE_WAIT. Sending FIN_ACK.\n");
          TransportP__sendTCPPacket(fd, ACK);
          TransportP__calcRTO(fd);
          ...
          case FIN_WAIT_1: 
            ...
            sim_log_debug(241U, TRANSPORT_CHANNEL, "Last FIN received. Sending ACK. Going to TIME_WAIT.\n");
          TransportP__sendTCPPacket(fd, ACK);
          TransportP__sockets[sim_node()][fd - 1].state = TIME_WAIT;
          TransportP__sockets[sim_node()][fd - 1].RTO = TransportP__TransmissionTimer__getNow() + 4 * TransportP__sockets[sim_node()][fd - 1].RTT;
          return SUCCESS;
          case FIN_WAIT_2: 
            case TIME_WAIT: 
              sim_log_debug(242U, TRANSPORT_CHANNEL, "Sending ACK on node %u via port %u with seq: %u. Going to TIME_WAIT.\n", TOS_NODE_ID, __nesc_ntoh_uint8(tcp_rcvd->destPort.nxdata), __nesc_ntoh_uint16(tcp_rcvd->seq.nxdata));
          TransportP__sendTCPPacket(fd, ACK);
...
# 84 "lib/interfaces/Transport.nc"
inline static error_t DistanceVectorRoutingP__Transport__receive(pack *package){
#line 84
  unsigned char __nesc_result;
#line 84
...
# 6 "lib/interfaces/DistanceVectorRouting.nc"
inline static void TransportP__DistanceVectorRouting__routePacket(pack *myMsg){
#line 6
  DistanceVectorRoutingP__DistanceVectorRouting__routePacket(myMsg);
#line 6
}
...
# 352 "lib/modules/DistanceVectorRoutingP.nc"
static inline uint8_t DistanceVectorRoutingP__findNextHop(uint8_t dest)
#line 352
{
  uint16_t i;
...
#line 354
  for (i = 1; i < DistanceVectorRoutingP__numRoutes[sim_node()]; i++) {
      if (DistanceVectorRoutingP__routingTable[sim_node()][i].dest == dest) {
          if (DistanceVectorRoutingP__routingTable[sim_node()][i].dist == 18) {
              return 0;
            }
          else 
#line 358
            {
              return DistanceVectorRoutingP__routingTable[sim_node()][i].nextHop;
            }
        }
    }
  return 0;
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fc2493c5a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fc2493c5a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fc2493e0c70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fc2493e0c70, msg, error);
#line 110
}
#line 110
...
#line 52
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void ChatP__ChatTimer__startPeriodic(uint32_t dt){
#line 64
...
#line 64
#line 92
inline static bool ChatP__ChatTimer__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
inline static error_t ChatP__Transport__connect(socket_t fd, socket_addr_t *addr){
#line 115
  unsigned char __nesc_result;
#line 115
...
#line 115
#line 43
inline static error_t ChatP__Transport__bind(socket_t fd, socket_addr_t *addr){
#line 43
  unsigned char __nesc_result;
#line 43
...
#line 43
#line 29
inline static socket_t ChatP__Transport__socket(void ){
#line 29
  unsigned char __nesc_result;
#line 29
...
#line 29
#line 148
inline static error_t ChatP__Transport__listen(socket_t fd){
#line 148
  unsigned char __nesc_result;
#line 148
...
#line 380
  if (ChatP__chatApp[sim_node()].state != ChatP__OFF || ChatP__chatApp[sim_node()].listenSockFd > 0) {
      sim_log_debug(323U, CHAT_CHANNEL, "Cannot start client\n");
      return;
    }

  ChatP__chatApp[sim_node()].state = ChatP__CLIENT;
  ChatP__chatApp[sim_node()].listenSockFd = ChatP__Transport__socket();
  if (ChatP__chatApp[sim_node()].listenSockFd > 0) {
      __nesc_hton_uint16(addr.addr.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(addr.port.nxdata, 50);

      if (ChatP__Transport__bind(ChatP__chatApp[sim_node()].listenSockFd, &addr) == SUCCESS) {

          if (ChatP__Transport__listen(ChatP__chatApp[sim_node()].listenSockFd) == SUCCESS && !ChatP__ChatTimer__isRunning()) {
              sim_log_debug(324U, CHAT_CHANNEL, "Node %u listening on port 50\n", TOS_NODE_ID);
              ChatP__ChatTimer__startPeriodic(1024 + (uint16_t )(ChatP__Random__rand16() % 1000));
            }
        }
      else 
#line 397
        {
          sim_log_debug(325U, CHAT_CHANNEL, "Can't blind socket\n");
        }
    }
  else 
#line 400
    {
      sim_log_debug(326U, CHAT_CHANNEL, "Can't obtain socket\n");
    }

  __nesc_hton_uint8(addr.port.nxdata, clientPort);
  ChatP__chatApp[sim_node()].connections[0].writeFd = ChatP__Transport__socket();
  if (ChatP__chatApp[sim_node()].connections[0].writeFd == 0) {
      sim_log_debug(327U, CHAT_CHANNEL, "No sockets?. why don't you go outside get some sockets RIP!");
      return;
    }

  if (ChatP__Transport__bind(ChatP__chatApp[sim_node()].connections[0].writeFd, &addr) == FAIL) {
      sim_log_debug(328U, CHAT_CHANNEL, "Can't blind socket. RIP!");
      return;
    }
  __nesc_hton_uint16(addr.addr.nxdata, 1);
  __nesc_hton_uint8(addr.port.nxdata, 50);

  if (ChatP__Transport__connect(ChatP__chatApp[sim_node()].connections[0].writeFd, &addr) == FAIL) {
      sim_log_debug(329U, CHAT_CHANNEL, "Can't connect to Server. RIP!");
      return;
    }
  ChatP__chatApp[sim_node()].connections[0].sendRead = 0;
  ChatP__chatApp[sim_node()].connections[0].sendWritten = 0;
  if (!ChatP__ChatTimer__isRunning()) {
      ChatP__ChatTimer__startPeriodic(1024 + (uint16_t )(ChatP__Random__rand16() % 1000));
    }
}
...
#line 203
{
  ...
  sim_log_debug(310U, CHAT_CHANNEL, "CLIENT: Sending %s", message);
  if (message[len - 1] != '\n' || message[len - 2] != '\r') {
      sim_log_debug(311U, CHAT_CHANNEL, "Chat message: incorrectly ended RIP\n");
      return;
    }
  if (ChatP__startsWith(message, "hello ")) {
      if (len < 12) {
          sim_log_debug(312U, CHAT_CHANNEL, "Chat message: hello too short\n");
          return;
        }
      sim_log_debug(313U, CHAT_CHANNEL, "Sending hello! to Server\n");

      while (message[i] != ' ') {
          if (message[i] < '0' || message[i] > '9') {
              sim_log_debug(314U, CHAT_CHANNEL, "Chat message: ports is not a number RIP\n");
              return;
            }
      ...
      i = 0;
      while (i <= len) {
          memcpy(&ChatP__chatApp[sim_node()].connections[0].sendBuffer[ChatP__chatApp[sim_node()].connections[0].sendWritten++ % 256], message + i, 1);
          i++;
        }
    }
  else {
#line 240
    if ((ChatP__startsWith(message, "msg ") || ChatP__startsWith(message, "whisper ")) || ChatP__startsWith(message, "listusr\r\n")) {
        if (ChatP__chatApp[sim_node()].state != ChatP__CLIENT) {
            sim_log_debug(315U, CHAT_CHANNEL, "Chat message: say hello first or RIP\n");
            return;
          }
        i = 0;
        while (i <= len - 1) {
...
#line 251
      {
        sim_log_debug(316U, CHAT_CHANNEL, "Chat message: RIP command format\n");
      }
    }
}

# 7 "lib/interfaces/Chat.nc"
inline static void Node__Chat__chat(char *msg){
#line 7
  ChatP__Chat__chat(msg);
#line 7
}
#line 7
# 222 "Node.nc"
...
#line 222
{
  Node__Chat__chat(msg);
}

# 12 "lib/interfaces/CommandHandler.nc"
inline static void CommandHandlerP__CommandHandler__chat(char *msg){
#line 12
  Node__CommandHandler__chat(msg);
#line 12
}
#line 12
# 240 "lib/modules/ClientP.nc"
static inline void ClientP__zeroClient(uint8_t x)
#line 240
{
  ClientP__client[sim_node()][x].sockfd = 0;
  ClientP__client[sim_node()][x].bytesWritten = 0;
  ClientP__client[sim_node()][x].bytesTransferred = 0;
  ClientP__client[sim_node()][x].counter = 0;
  ClientP__client[sim_node()][x].transfer = 0;
}
...
#line 504
  ...
  switch (TransportP__sockets[sim_node()][fd - 1].state) {
      case LISTEN: 
        ...
        id = ((uint32_t )__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata) << 24) | ((uint32_t )__nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata) << 16);
      TransportP__SocketMap__remove(id);
      ...
      sim_log_debug(244U, TRANSPORT_CHANNEL, "FIN sent to port %u to node %u by node %u via port %u\n", __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), __nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].dest.addr.nxdata), TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata));
      sim_log_debug(245U, TRANSPORT_CHANNEL, "Going to FIN_WAIT_1\n");
...
# 126 "lib/interfaces/Transport.nc"
inline static error_t ClientP__Transport__close(socket_t fd){
#line 126
  unsigned char __nesc_result;
#line 126
...
#line 37
{
  return (/*ClientC.HashmapC*/HashmapC__2__hash2(k) + i * /*ClientC.HashmapC*/HashmapC__2__hash3(k)) % /*ClientC.HashmapC*/HashmapC__2__HASH_MAX_SIZE[sim_node()];
}
...
#line 132
  do {
      j = /*ClientC.HashmapC*/HashmapC__2__hash(k, i);
      if (/*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].key == k) {
        return /*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].value;
        }
#line 136
      i++;
    }
  while (
#line 137
  i < /*ClientC.HashmapC*/HashmapC__2__HASH_MAX_SIZE[sim_node()]);


  return /*ClientC.HashmapC*/HashmapC__2__map[sim_node()][0].value;
}

# 13 "dataStructures/interfaces/Hashmap.nc"
inline static ClientP__ConnectionMap__t ClientP__ConnectionMap__get(uint32_t key){
#line 13
  unsigned char __nesc_result;
#line 13

#line 13
  __nesc_result = /*ClientC.HashmapC*/HashmapC__2__Hashmap__get(key);
#line 13
...
#line 147
  ...
  sockx = ClientP__ConnectionMap__get(connId);
  if (sockx == 0) {
      sim_log_debug(281U, TRANSPORT_CHANNEL, "Client not found\n");
      return;
    }
  ClientP__Transport__close(ClientP__client[sim_node()][sockx - 1].sockfd);
  ClientP__zeroClient(sockx - 1);
  ClientP__numClients[sim_node()]--;
}

# 8 "lib/interfaces/Client.nc"
inline static void Node__Client__closeClient(uint8_t srcPort, uint8_t destPort, uint8_t dest){
#line 8
  ClientP__Client__closeClient(srcPort, destPort, dest);
#line 8
}
#line 8
# 214 "Node.nc"
...
#line 214
{
  sim_log_debug(114U, TRANSPORT_CHANNEL, "Closing connection from port %u to port %u on node %u.\n", srcPort, destPort, dest);
  Node__Client__closeClient(dest, srcPort, destPort);
}
...
#line 10
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
inline static uint16_t ClientP__Random__rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void ClientP__ClientTimer__startPeriodic(uint32_t dt){
#line 64
...
#line 64
#line 92
inline static bool ClientP__ClientTimer__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
# 148 "lib/interfaces/Transport.nc"
inline static error_t ClientP__Transport__listen(socket_t fd){
#line 148
  unsigned char __nesc_result;
#line 148
...
#line 148
# 11 "dataStructures/interfaces/Hashmap.nc"
inline static void ClientP__ConnectionMap__insert(uint32_t key, ClientP__ConnectionMap__t input){
#line 11
  /*ClientC.HashmapC*/HashmapC__2__Hashmap__insert(key, input);
#line 11
}
#line 11
# 43 "lib/interfaces/Transport.nc"
inline static error_t ClientP__Transport__bind(socket_t fd, socket_addr_t *addr){
#line 43
  unsigned char __nesc_result;
#line 43
...
#line 43
#line 29
inline static socket_t ClientP__Transport__socket(void ){
#line 29
  unsigned char __nesc_result;
#line 29
...
#line 61
  if (ClientP__numServers[sim_node()] >= MAX_NUM_OF_SOCKETS) {
      sim_log_debug(276U, TRANSPORT_CHANNEL, "Cannot start server\n");
      return;
    }
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (ClientP__server[sim_node()][i].sockfd != 0) {
        continue;
        }
#line 68
      ClientP__server[sim_node()][i].sockfd = ClientP__Transport__socket();
      if (ClientP__server[sim_node()][i].sockfd > 0) {

          __nesc_hton_uint16(addr.addr.nxdata, TOS_NODE_ID);
          __nesc_hton_uint8(addr.port.nxdata, port);

          if (ClientP__Transport__bind(ClientP__server[sim_node()][i].sockfd, &addr) == SUCCESS) {
              connId = ((uint32_t )__nesc_ntoh_uint16(addr.addr.nxdata) << 24) | ((uint32_t )__nesc_ntoh_uint8(addr.port.nxdata) << 16);
              ClientP__ConnectionMap__insert(connId, i + 1);
              ClientP__server[sim_node()][i].bytesRead = 0;
              ClientP__server[sim_node()][i].bytesWritten = 0;
              ClientP__server[sim_node()][i].numConns = 0;
              if (ClientP__Transport__listen(ClientP__server[sim_node()][i].sockfd) == SUCCESS && !ClientP__ClientTimer__isRunning()) {
                  ClientP__ClientTimer__startPeriodic(1024 + (uint16_t )(ClientP__Random__rand16() % 1000));
                }
              ClientP__numServers[sim_node()]++;
              return;
            }
        }
    }
...
# 6 "lib/interfaces/Client.nc"
inline static void Node__Client__startServer(uint8_t port){
#line 6
  ClientP__Client__startServer(port);
#line 6
}
#line 6
# 204 "Node.nc"
...
#line 204
{
  Node__Client__startServer(port);
  sim_log_debug(112U, TRANSPORT_CHANNEL, "Node %u listening on port %u\n", TOS_NODE_ID, port);
}
...
#line 79
  sim_log_debug(298U, HASHMAP_CHANNEL, "Removing entry %d\n", k);
  for (i = 0; i < /*ClientC.HashmapC*/HashmapC__2__numofVals[sim_node()]; i++) {



      if (/*ClientC.HashmapC*/HashmapC__2__keys[sim_node()][i] == k) {
          sim_log_debug(299U, HASHMAP_CHANNEL, "Key found at %d\n", i);


          for (j = i; j < /*ClientC.HashmapC*/HashmapC__2__HASH_MAX_SIZE[sim_node()]; j++) {

              if (/*ClientC.HashmapC*/HashmapC__2__keys[sim_node()][j] == /*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[sim_node()]) {
#line 90
                break;
                }
#line 91
              sim_log_debug(300U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(301U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*ClientC.HashmapC*/HashmapC__2__keys[sim_node()][j], /*ClientC.HashmapC*/HashmapC__2__keys[sim_node()][j + 1]);
              /*ClientC.HashmapC*/HashmapC__2__keys[sim_node()][j] = /*ClientC.HashmapC*/HashmapC__2__keys[sim_node()][j + 1];
            }



          /*ClientC.HashmapC*/HashmapC__2__keys[sim_node()][/*ClientC.HashmapC*/HashmapC__2__numofVals[sim_node()]] = /*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[sim_node()];

          /*ClientC.HashmapC*/HashmapC__2__numofVals[sim_node()]--;
          sim_log_debug(302U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 112
  do {
      j = /*ClientC.HashmapC*/HashmapC__2__hash(k, i);
      if (/*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].key == k) {
          /*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].key = 0;
          removed = 1;
          break;
        }
      i++;
...
#line 120
  ...
  if (removed) 
    {
      /*ClientC.HashmapC*/HashmapC__2__removeFromKeyList(k);
    }
}

# 12 "dataStructures/interfaces/Hashmap.nc"
inline static void ClientP__ConnectionMap__remove(uint32_t key){
#line 12
  /*ClientC.HashmapC*/HashmapC__2__Hashmap__remove(key);
#line 12
}
#line 12
# 115 "lib/interfaces/Transport.nc"
inline static error_t ClientP__Transport__connect(socket_t fd, socket_addr_t *addr){
#line 115
  unsigned char __nesc_result;
#line 115
...
#line 90
{
  ...
  if (ClientP__numClients[sim_node()] >= MAX_NUM_OF_SOCKETS) {
      sim_log_debug(277U, TRANSPORT_CHANNEL, "Cannot start client\n");
      return;
    }
  ...
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (ClientP__client[sim_node()][i].sockfd != 0) {
          continue;
        }
      ClientP__client[sim_node()][i].sockfd = ClientP__Transport__socket();
      if (ClientP__client[sim_node()][i].sockfd == 0) {
          sim_log_debug(278U, TRANSPORT_CHANNEL, "No available sockets. Exiting!");
          return;
        }

      if (ClientP__Transport__bind(ClientP__client[sim_node()][i].sockfd, &clientAddr) == FAIL) {
          sim_log_debug(279U, TRANSPORT_CHANNEL, "Failed to bind sockets. Exiting!");
          return;
        }
      ...
      if (ClientP__Transport__connect(ClientP__client[sim_node()][i].sockfd, &serverAddr) == FAIL) {
          sim_log_debug(280U, TRANSPORT_CHANNEL, "Failed to connect to server. Exiting!");
          return;
        }

      ClientP__ConnectionMap__remove(connId);
      connId = ((((uint32_t )TOS_NODE_ID << 24) | ((uint32_t )srcPort << 16)) | ((uint32_t )dest << 16)) | ((uint32_t )destPort << 16);
      ClientP__ConnectionMap__insert(connId, i + 1);

      ClientP__client[sim_node()][i].transfer = transfer;
      ClientP__client[sim_node()][i].counter = 0;
      ClientP__client[sim_node()][i].bytesWritten = 0;
      ClientP__client[sim_node()][i].bytesTransferred = 0;

      if (!ClientP__ClientTimer__isRunning()) {
          ClientP__ClientTimer__startPeriodic(1024 + (uint16_t )(ClientP__Random__rand16() % 1000));
        }
      ClientP__numClients[sim_node()]++;
      return;
...
# 7 "lib/interfaces/Client.nc"
inline static void Node__Client__startClient(uint8_t dest, uint8_t srcPort, uint8_t destPort, uint16_t transfer){
#line 7
  ClientP__Client__startClient(dest, srcPort, destPort, transfer);
#line 7
}
#line 7
# 209 "Node.nc"
...
#line 209
{
  Node__Client__startClient(dest, srcPort, destPort, transfer);
  sim_log_debug(113U, TRANSPORT_CHANNEL, "Creating connection from port %u to port %u on node %u. bytes: %u\n", srcPort, destPort, dest, transfer);
}

# 9 "lib/interfaces/CommandHandler.nc"
inline static void CommandHandlerP__CommandHandler__setTestClient(uint8_t dest, uint8_t srcPort, uint8_t destPort, uint16_t payload){
#line 9
  Node__CommandHandler__setTestClient(dest, srcPort, destPort, payload);
#line 9
}
#line 9
# 342 "lib/modules/DistanceVectorRoutingP.nc"
static inline void DistanceVectorRoutingP__DistanceVectorRouting__printRouteTable(void )
#line 342
{
  uint16_t i;
...
#line 344
  sim_log_debug(203U, GENERAL_CHANNEL, "|\tRoutingTable of node:%d\t|\t\n", TOS_NODE_ID);
  sim_log_debug(204U, GENERAL_CHANNEL, "|\tdest---next_hop----dist-|\t\n");
  for (i = 0; i < DistanceVectorRoutingP__numRoutes[sim_node()]; i++) {
      sim_log_debug(205U, ROUTING_CHANNEL, "|   %4d|\t%5d|\t%6d\t|\t\n", DistanceVectorRoutingP__routingTable[sim_node()][i].dest, DistanceVectorRoutingP__routingTable[sim_node()][i].nextHop, DistanceVectorRoutingP__routingTable[sim_node()][i].dist);
    }
  sim_log_debug(206U, GENERAL_CHANNEL, "----------------------------\n");
}
...
# 243 "lib/modules/DistanceVectorRoutingP.nc"
static inline void DistanceVectorRoutingP__DistanceVectorRouting__ping(uint16_t destination, uint8_t *payload)
#line 243
{
  ...
  sim_log_debug(196U, ROUTING_CHANNEL, "PING FROM %d TO %d\n", TOS_NODE_ID, destination);
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(115U, COMMAND_CHANNEL, "A Command has been Issued.\n");
      ...
      switch (commandID) {
          ...
          case CMD_PING: 
            sim_log_debug(116U, COMMAND_CHANNEL, "Command Type: Ping\n");
          CommandHandlerP__CommandHandler__ping(buff[0], &buff[1]);
          break;

          case CMD_NEIGHBOR_DUMP: 
            sim_log_debug(117U, COMMAND_CHANNEL, "Command Type: Neighbor Dump\n");
          CommandHandlerP__CommandHandler__printNeighbors();
          break;

          case CMD_LINKSTATE_DUMP: 
            sim_log_debug(118U, COMMAND_CHANNEL, "Command Type: Link State Dump\n");
          CommandHandlerP__CommandHandler__printLinkState();
          break;

          case CMD_ROUTETABLE_DUMP: 
            sim_log_debug(119U, COMMAND_CHANNEL, "Command Type: Route Table Dump\n");
          CommandHandlerP__CommandHandler__printRouteTable();
          break;

          case CMD_TEST_CLIENT: 
            sim_log_debug(120U, COMMAND_CHANNEL, "Command Type: Test Client\n");
          CommandHandlerP__CommandHandler__setTestClient(buff[0], buff[1], buff[2], (buff[3] << 8) | buff[4]);
          break;

          case CMD_TEST_SERVER: 
            sim_log_debug(121U, COMMAND_CHANNEL, "Command Type: Test Server\n");
          CommandHandlerP__CommandHandler__setTestServer(buff[0]);
          break;

          case CMD_CLIENT_CLOSE: 
            sim_log_debug(122U, COMMAND_CHANNEL, "Command Type: Closing Client\n");
          CommandHandlerP__CommandHandler__setClientClose(buff[0], buff[1], buff[2]);
          break;
          case CMD_CHAT: 
            sim_log_debug(123U, COMMAND_CHANNEL, "Command Type: Chat\n");
          CommandHandlerP__CommandHandler__chat(&buff[0]);
          break;
          default: 
...
#line 53
{
  return /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[sim_node()] == 0;
}

# 50 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static bool /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__empty(void ){
#line 50
  unsigned char __nesc_result;
#line 50

#line 50
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__empty();
#line 50
...
#line 103
{
  if (/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()] >= 20) {
      return FAIL;
    }
  else {
      uint16_t emptyIndex = /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()] + /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()];

#line 109
      if (emptyIndex >= 20) {
          emptyIndex -= 20;
        }
      /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[sim_node()][emptyIndex] = newVal;
      /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()]++;
...
# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
inline static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__put(/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__t * newVal){
#line 89
  unsigned char __nesc_result;
#line 89

#line 89
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Pool__put(newVal);
#line 89
...
#line 69
{
  return /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue[sim_node()][/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[sim_node()]];
}
...
#line 89
{
  /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue_t t = /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__head();

#line 91
  sim_log_debug(221U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[sim_node()]);
  if (!/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__empty()) {
      /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[sim_node()]++;
      if (/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[sim_node()] == 20) {
#line 94
        /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[sim_node()] = 0;
        }
#line 95
      /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[sim_node()]--;
      /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__printQueue();
...
# 88 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__dequeue(void ){
#line 88
  struct sendInfo *__nesc_result;
#line 88

#line 88
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__dequeue();
#line 88
...
#line 88
# 75 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static error_t /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/tinyos-main/tos/interfaces/AMPacket.nc"
inline static void /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC__AMPacket__setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 6);
  return /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 80
...
#line 80
# 126 "/opt/tinyos-main/tos/interfaces/Packet.nc"
inline static void * /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 118
{
  if (!/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[sim_node()]) {



      pack *msg = (pack *)/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Packet__getPayload(&/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[sim_node()], sizeof(pack ));


      *msg = *message;


      if (/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__send(dest, &/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[sim_node()], sizeof(pack )) == SUCCESS) {

          /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[sim_node()] = TRUE;
          return SUCCESS;
        }
      else 
#line 133
        {
          ...
          sim_log_debug(209U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(210U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(211U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}

# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__t  /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__head(void ){
#line 80
  struct sendInfo *__nesc_result;
#line 80

#line 80
  __nesc_result = /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__Queue__head();
#line 80
...
#line 74
{
  ...
  if (!/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__empty() && !/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[sim_node()]) {
      sendInfo *info;




      info = /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__head();


      if (SUCCESS == /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__send(info->src, info->dest, & info->packet)) {

          /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__dequeue();
          /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__put(info);
        }
    }
  ...
  if (!/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__empty()) {
      /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__postSendTask();
    }
}
...
#line 53
{
  return /*TransportC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()] == 0;
}

# 50 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static bool /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__empty(void ){
#line 50
  unsigned char __nesc_result;
#line 50

#line 50
  __nesc_result = /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__empty();
#line 50
...
#line 103
{
  if (/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[sim_node()] >= 20) {
      return FAIL;
    }
  else {
      uint16_t emptyIndex = /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__index[sim_node()] + /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[sim_node()];

#line 109
      if (emptyIndex >= 20) {
          emptyIndex -= 20;
        }
      /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__queue[sim_node()][emptyIndex] = newVal;
      /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[sim_node()]++;
      sim_log_debug(262U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[sim_node()]);
      return SUCCESS;
    }
}

# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
inline static error_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Pool__put(/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Pool__t * newVal){
#line 89
  unsigned char __nesc_result;
#line 89

#line 89
  __nesc_result = /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__Pool__put(newVal);
#line 89
...
#line 76
  ...
  for (i = /*TransportC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()]; i < /*TransportC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()] + /*TransportC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()]; i++) {
      sim_log_debug_clear(264U, "QueueC", "[");
      for (j = 0; j < sizeof(/*TransportC.SimpleSendC.QueueC*/QueueC__3__queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*TransportC.SimpleSendC.QueueC*/QueueC__3__queue[sim_node()][i % 20])[j];
...
#line 69
{
  return /*TransportC.SimpleSendC.QueueC*/QueueC__3__queue[sim_node()][/*TransportC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()]];
}
...
#line 89
{
  /*TransportC.SimpleSendC.QueueC*/QueueC__3__queue_t t = /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__head();

#line 91
  sim_log_debug(268U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*TransportC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()]);
  if (!/*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__empty()) {
      /*TransportC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()]++;
      if (/*TransportC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()] == 20) {
#line 94
        /*TransportC.SimpleSendC.QueueC*/QueueC__3__head[sim_node()] = 0;
        }
#line 95
      /*TransportC.SimpleSendC.QueueC*/QueueC__3__size[sim_node()]--;
      /*TransportC.SimpleSendC.QueueC*/QueueC__3__printQueue();
    }
  return t;
}

# 88 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__t  /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__dequeue(void ){
#line 88
  struct sendInfo *__nesc_result;
#line 88

#line 88
  __nesc_result = /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__dequeue();
#line 88
...
#line 88
# 75 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static error_t /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/tinyos-main/tos/interfaces/AMPacket.nc"
inline static void /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC__AMPacket__setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(msg, dest);
  /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(msg, 6);
  return /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(msg, len);
}

# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(addr, msg, len);
#line 80
...
#line 80
# 126 "/opt/tinyos-main/tos/interfaces/Packet.nc"
inline static void * /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 118
{
  if (!/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy[sim_node()]) {



      pack *msg = (pack *)/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Packet__getPayload(&/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt[sim_node()], sizeof(pack ));


      *msg = *message;


      if (/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__AMSend__send(dest, &/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt[sim_node()], sizeof(pack )) == SUCCESS) {

          /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy[sim_node()] = TRUE;
          return SUCCESS;
        }
      else 
#line 133
        {
          ...
          sim_log_debug(256U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(257U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(258U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}

# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__t  /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__head(void ){
#line 80
  struct sendInfo *__nesc_result;
#line 80

#line 80
  __nesc_result = /*TransportC.SimpleSendC.QueueC*/QueueC__3__Queue__head();
#line 80
...
#line 74
{
  ...
  if (!/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__empty() && !/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy[sim_node()]) {
      sendInfo *info;




      info = /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__head();


      if (SUCCESS == /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__send(info->src, info->dest, & info->packet)) {

          /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__dequeue();
          /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Pool__put(info);
        }
    }
  ...
  if (!/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Queue__empty()) {
      /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__postSendTask();
    }
}
...
#line 53
{
  return /*ClientC.SimpleSendC.QueueC*/QueueC__4__size[sim_node()] == 0;
}

# 50 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static bool /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__empty(void ){
#line 50
  unsigned char __nesc_result;
#line 50

#line 50
  __nesc_result = /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__empty();
#line 50
...
#line 103
{
  if (/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[sim_node()] >= 20) {
      return FAIL;
    }
  else {
      uint16_t emptyIndex = /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__index[sim_node()] + /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[sim_node()];

#line 109
      if (emptyIndex >= 20) {
          emptyIndex -= 20;
        }
      /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__queue[sim_node()][emptyIndex] = newVal;
      /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[sim_node()]++;
      sim_log_debug(289U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[sim_node()]);
      return SUCCESS;
    }
}

# 89 "/opt/tinyos-main/tos/interfaces/Pool.nc"
inline static error_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Pool__put(/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Pool__t * newVal){
#line 89
  unsigned char __nesc_result;
#line 89

#line 89
  __nesc_result = /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__Pool__put(newVal);
#line 89
...
#line 76
  sim_log_debug(290U, "QueueC", "head <-");
  for (i = /*ClientC.SimpleSendC.QueueC*/QueueC__4__head[sim_node()]; i < /*ClientC.SimpleSendC.QueueC*/QueueC__4__head[sim_node()] + /*ClientC.SimpleSendC.QueueC*/QueueC__4__size[sim_node()]; i++) {
      sim_log_debug_clear(291U, "QueueC", "[");
      for (j = 0; j < sizeof(/*ClientC.SimpleSendC.QueueC*/QueueC__4__queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*ClientC.SimpleSendC.QueueC*/QueueC__4__queue[sim_node()][i % 20])[j];

#line 81
          sim_log_debug_clear(292U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(293U, "QueueC", "] ");
    }
  sim_log_debug_clear(294U, "QueueC", "<- tail\n");
}
...
#line 69
{
  return /*ClientC.SimpleSendC.QueueC*/QueueC__4__queue[sim_node()][/*ClientC.SimpleSendC.QueueC*/QueueC__4__head[sim_node()]];
}
...
#line 89
{
  /*ClientC.SimpleSendC.QueueC*/QueueC__4__queue_t t = /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__head();

#line 91
  sim_log_debug(295U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*ClientC.SimpleSendC.QueueC*/QueueC__4__size[sim_node()]);
  if (!/*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__empty()) {
      /*ClientC.SimpleSendC.QueueC*/QueueC__4__head[sim_node()]++;
      if (/*ClientC.SimpleSendC.QueueC*/QueueC__4__head[sim_node()] == 20) {
#line 94
        /*ClientC.SimpleSendC.QueueC*/QueueC__4__head[sim_node()] = 0;
        }
#line 95
      /*ClientC.SimpleSendC.QueueC*/QueueC__4__size[sim_node()]--;
      /*ClientC.SimpleSendC.QueueC*/QueueC__4__printQueue();
    }
  return t;
}

# 88 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__t  /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__dequeue(void ){
#line 88
  struct sendInfo *__nesc_result;
#line 88

#line 88
  __nesc_result = /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__dequeue();
#line 88
...
#line 88
# 75 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static error_t /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/tinyos-main/tos/interfaces/AMPacket.nc"
inline static void /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC__AMPacket__setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMPacket__setDestination(msg, dest);
  /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMPacket__setType(msg, 6);
  return /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__Send__send(msg, len);
}

# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMSend__send(addr, msg, len);
#line 80
...
#line 80
# 126 "/opt/tinyos-main/tos/interfaces/Packet.nc"
inline static void * /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 118
{
  if (!/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy[sim_node()]) {



      pack *msg = (pack *)/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Packet__getPayload(&/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt[sim_node()], sizeof(pack ));


      *msg = *message;


      if (/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__AMSend__send(dest, &/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt[sim_node()], sizeof(pack )) == SUCCESS) {

          /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy[sim_node()] = TRUE;
          return SUCCESS;
        }
      else 
#line 133
        {
          ...
          sim_log_debug(283U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(284U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(285U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}

# 80 "/opt/tinyos-main/tos/interfaces/Queue.nc"
inline static /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__t  /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__head(void ){
#line 80
  struct sendInfo *__nesc_result;
#line 80

#line 80
  __nesc_result = /*ClientC.SimpleSendC.QueueC*/QueueC__4__Queue__head();
#line 80
...
#line 74
{
  ...
  if (!/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__empty() && !/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy[sim_node()]) {
      sendInfo *info;




      info = /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__head();


      if (SUCCESS == /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__send(info->src, info->dest, & info->packet)) {

          /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__dequeue();
          /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Pool__put(info);
        }
    }
  ...
  if (!/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Queue__empty()) {
      /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__postSendTask();
    }
}
...
#line 103
{
  if (/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[sim_node()] >= 20) {
      return FAIL;
    }
  else {
      uint16_t emptyIndex = /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__index[sim_node()] + /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[sim_node()];

#line 109
      if (emptyIndex >= 20) {
          emptyIndex -= 20;
        }
      /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__queue[sim_node()][emptyIndex] = newVal;
      /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[sim_node()]++;
      sim_log_debug(336U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[sim_node()]);
      return SUCCESS;
    }
}
...
#line 89
  __nesc_result = /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__Pool__put(newVal);
#line 89
...
#line 76
  sim_log_debug(337U, "QueueC", "head <-");
  for (i = /*ChatC.SimpleSendC.QueueC*/QueueC__5__head[sim_node()]; i < /*ChatC.SimpleSendC.QueueC*/QueueC__5__head[sim_node()] + /*ChatC.SimpleSendC.QueueC*/QueueC__5__size[sim_node()]; i++) {
      sim_log_debug_clear(338U, "QueueC", "[");
...
#line 81
          sim_log_debug_clear(339U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(340U, "QueueC", "] ");
    }
  sim_log_debug_clear(341U, "QueueC", "<- tail\n");
}
...
#line 133
        {
          ...
          sim_log_debug(330U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(331U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(332U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fc2495aa020){
#line 75
  switch (arg_0x7fc2495aa020) {
#line 75
...
#line 75
      break;
#line 75
    case /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask:
#line 75
      /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__runTask();
#line 75
      break;
#line 75
    case /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask:
#line 75
      /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask__runTask();
#line 75
      break;
#line 75
    case /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask:
#line 75
      /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask__runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fc2495aa020);
#line 75
      break;
#line 75
    }
...
#line 78
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fc248c73b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fc248c73b60, addr, msg, len);
#line 80
...
#line 150
{
  ...
  if (&/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt[sim_node()] == msg) {
      /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy[sim_node()] = FALSE;
      /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__postSendTask();
    }
}

# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__AMSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-main/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__AMSend__sendDone(m, err);
}

# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static bool /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
#line 73
inline static void /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__startOneShot(uint32_t dt){
#line 73
...
#line 73
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
inline static uint16_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Random__rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 150
{
  ...
  if (&/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt[sim_node()] == msg) {
      /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy[sim_node()] = FALSE;
      /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__postSendTask();
    }
}

# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__AMSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-main/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(m, err);
}

# 92 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static bool /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
#line 73
inline static void /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__startOneShot(uint32_t dt){
#line 73
...
#line 73
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
inline static uint16_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Random__rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 150
{
  ...
  if (&/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[sim_node()] == msg) {
      /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[sim_node()] = FALSE;
      /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__postSendTask();
    }
}

# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__AMSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-main/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 94 "lib/modules/NeighborDiscoveryP.nc"
static inline void NeighborDiscoveryP__makePack(pack *Package, uint16_t src, uint16_t dest, uint16_t TTL, uint16_t protocol, uint16_t seq, uint8_t *payload, uint8_t length)
#line 94
{
  __nesc_hton_uint16(Package->src.nxdata, src);
...
#line 13
  __nesc_result = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__get(key);
#line 13
...
#line 79
  sim_log_debug(190U, HASHMAP_CHANNEL, "Removing entry %d\n", k);
  for (i = 0; i < /*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[sim_node()]; i++) {



      if (/*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()][i] == k) {
          sim_log_debug(191U, HASHMAP_CHANNEL, "Key found at %d\n", i);


          for (j = i; j < /*NeighborDiscoveryC.Neighbors*/HashmapC__0__HASH_MAX_SIZE[sim_node()]; j++) {

              if (/*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()][j] == /*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[sim_node()]) {
#line 90
                break;
                }
#line 91
              sim_log_debug(192U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(193U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()][j], /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()][j + 1]);
              /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()][j] = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()][j + 1];
            }



          /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()][/*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[sim_node()]] = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[sim_node()];

          /*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[sim_node()]--;
          sim_log_debug(194U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 112
  do {
      j = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hash(k, i);
      if (/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].key == k) {
          /*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].key = 0;
          removed = 1;
          break;
        }
      i++;
...
#line 120
  ...
  if (removed) 
    {
      /*NeighborDiscoveryC.Neighbors*/HashmapC__0__removeFromKeyList(k);
    }
}
...
#line 12
  /*NeighborDiscoveryC.Neighbors*/HashmapC__0__Hashmap__remove(key);
#line 12
}
#line 12
...
#line 327
  sim_log_debug(202U, ROUTING_CHANNEL, "Neighbor discovery has lost neighbor %u. Distance is now infinite!\n", lostNeighbor);
  for (i = 1; i < DistanceVectorRoutingP__numRoutes[sim_node()]; i++) {
      if (DistanceVectorRoutingP__routingTable[sim_node()][i].dest == lostNeighbor || DistanceVectorRoutingP__routingTable[sim_node()][i].nextHop == lostNeighbor) {
          DistanceVectorRoutingP__routingTable[sim_node()][i].dist = 18;
        }
    }
  DistanceVectorRoutingP__triggerUpdate();
}
...
#line 8
# 48 "lib/modules/NeighborDiscoveryP.nc"
static inline void NeighborDiscoveryP__NeighborDiscoveryTimer__fired(void )
#line 48
{
  uint16_t i = 0;
...
#line 52
  ...
  for (; i < NeighborDiscoveryP__Neighbors__size(); i++) {
      if (keys[i] == 0) {
          continue;
        }
      if (NeighborDiscoveryP__Neighbors__get(keys[i]) == 0) {
          sim_log_debug(139U, NEIGHBOR_CHANNEL, "Removing Neighbor %d\n", keys[i]);
          NeighborDiscoveryP__DistanceVectorRouting__handleNeighborLost(keys[i]);
          NeighborDiscoveryP__Neighbors__remove(keys[i]);
        }
      else 
#line 62
        {
          NeighborDiscoveryP__Neighbors__insert(keys[i], NeighborDiscoveryP__Neighbors__get(keys[i]) - 1);
        }
    }
...
# 67 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static error_t /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask);
#line 67
...
#line 103
{
  /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendBufferTask__postTask();
}

# 382 "lib/modules/DistanceVectorRoutingP.nc"
static inline void DistanceVectorRoutingP__removeRoute(uint8_t idx)
#line 382
{
  uint8_t j;
  ...
  for (j = idx + 1; j < DistanceVectorRoutingP__numRoutes[sim_node()]; j++) {
      ...
      DistanceVectorRoutingP__routingTable[sim_node()][j - 1].dist = DistanceVectorRoutingP__routingTable[sim_node()][j].dist;
  ...
  DistanceVectorRoutingP__routingTable[sim_node()][j - 1].dist = 18;
...
#line 401
  for (i = 1; i < DistanceVectorRoutingP__numRoutes[sim_node()]; i++) {
      ...
      if (DistanceVectorRoutingP__routingTable[sim_node()][i].ttl == 0) {
          sim_log_debug(207U, ROUTING_CHANNEL, "Route stale, removing: %u\n", DistanceVectorRoutingP__routingTable[sim_node()][i].dest);
...
#line 98
  __nesc_result = /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__isOneShot(3U);
#line 98
...
#line 98
# 230 "lib/modules/DistanceVectorRoutingP.nc"
static inline void DistanceVectorRoutingP__DVRTimer__fired(void )
#line 230
{
...
# 67 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static error_t /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask);
#line 67
...
#line 103
{
  /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendBufferTask__postTask();
}
...
#line 52
# 64 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void TransportP__TransmissionTimer__startPeriodic(uint32_t dt){
#line 64
...
#line 64
#line 98
inline static bool TransportP__TransmissionTimer__isOneShot(void ){
#line 98
  unsigned char __nesc_result;
#line 98

#line 98
  __nesc_result = /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__isOneShot(5U);
#line 98
...
#line 61
  if (TransportP__TransmissionTimer__isOneShot()) {
      sim_log_debug(223U, TRANSPORT_CHANNEL, "TCP starting on node %u\n", TOS_NODE_ID);
      TransportP__TransmissionTimer__startPeriodic(512 + (uint16_t )(TransportP__Random__rand16() % 100));
    }


  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      if (TransportP__sockets[sim_node()][i].RTO < TransportP__TransmissionTimer__getNow()) {

          switch (TransportP__sockets[sim_node()][i].state) {
              case ESTABLISHED: 
                if (TransportP__sockets[sim_node()][i].lastSent != TransportP__sockets[sim_node()][i].lastAck && TransportP__sockets[sim_node()][i].type == CLIENT && TransportP__getSDatainFlight(i + 1) > 0) {

                    TransportP__sockets[sim_node()][i].lastSent = TransportP__sockets[sim_node()][i].lastAck;
                    TransportP__sockets[sim_node()][i].ssthresh = TransportP__max(TransportP__calCong(i + 1) >> 1, 5 * sizeof(nx_uint16_t ));
...
#line 86
                  if (TransportP__sockets[sim_node()][i].type == SERVER && TransportP__sockets[sim_node()][i].deadlockAck) {
                      ...
                      TransportP__sockets[sim_node()][i].RTO = TransportP__TransmissionTimer__getNow() + 4096;
                    }
                  }
#line 91
              break;
              ...
              break;
              case CLOSE_WAIT: 
                sim_log_debug(224U, TRANSPORT_CHANNEL, "Resending FIN. Going to LAST_ACK\n");
              TransportP__sendTCPPacket(i + 1, FIN);
              TransportP__sockets[sim_node()][i].state = LAST_ACK;

              TransportP__sockets[sim_node()][i].RTO = TransportP__TransmissionTimer__getNow() + 4 * TransportP__sockets[sim_node()][i].RTT;
              break;
              case FIN_WAIT_1: 
                case LAST_ACK: 
                  TransportP__calcRTO(i + 1);
              ...
              sim_log_debug(225U, TRANSPORT_CHANNEL, "CONNECTION CLOSED!\n");
            }
        }
...
# 67 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static error_t /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask);
#line 67
...
#line 103
{
  /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendBufferTask__postTask();
}

# 74 "lib/interfaces/Transport.nc"
inline static uint16_t ClientP__Transport__write(socket_t fd, uint8_t *buff, uint16_t bufflen){
#line 74
  unsigned short __nesc_result;
#line 74
...
#line 284
{
  return 1024 - ClientP__clientOccupied(x) - 1;
}
...
#line 213
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      ...
      while (ClientP__clientAvailable(i) > 0 && ClientP__client[sim_node()][i].counter < ClientP__client[sim_node()][i].transfer) {
          if (ClientP__client[sim_node()][i].bytesWritten == 1024) {
              ClientP__client[sim_node()][i].bytesWritten = 0;
            }
          if ((ClientP__client[sim_node()][i].bytesWritten & 1) == 0) {
              ClientP__client[sim_node()][i].buffer[ClientP__client[sim_node()][i].bytesWritten] = ClientP__client[sim_node()][i].counter & 0xFF;
            }
          else 
#line 223
            {
              ClientP__client[sim_node()][i].buffer[ClientP__client[sim_node()][i].bytesWritten] = ClientP__client[sim_node()][i].counter >> 8;
              ClientP__client[sim_node()][i].counter++;
            }
          ClientP__client[sim_node()][i].bytesWritten++;
        }

      if (ClientP__clientOccupied(i) > 0) {
          bytesToTransfer = ClientP__min(1024 - ClientP__client[sim_node()][i].bytesTransferred, ClientP__client[sim_node()][i].bytesWritten - ClientP__client[sim_node()][i].bytesTransferred);
          bytesTransferred = ClientP__Transport__write(ClientP__client[sim_node()][i].sockfd, &ClientP__client[sim_node()][i].buffer[ClientP__client[sim_node()][i].bytesTransferred], bytesToTransfer);
          ClientP__client[sim_node()][i].bytesTransferred += bytesTransferred;
        }
      if (ClientP__client[sim_node()][i].bytesTransferred == 1024) {
        ClientP__client[sim_node()][i].bytesTransferred = 0;
        }
    }
}
...
inline static uint16_t ClientP__Transport__read(socket_t fd, uint8_t *buff, uint16_t bufflen){
#line 101
  unsigned short __nesc_result;
#line 101
...
#line 101
# 269 "lib/modules/ClientP.nc"
static inline uint16_t ClientP__serverAvailable(uint8_t x)
#line 269
{
  return 1024 - ClientP__serverOccupied(x) - 1;
}

# 57 "lib/interfaces/Transport.nc"
inline static socket_t ClientP__Transport__accept(socket_t fd){
#line 57
  unsigned char __nesc_result;
#line 57
...
#line 168
  for (i = 0; i < ClientP__numServers[sim_node()]; i++) {
      if (ClientP__server[sim_node()][i].sockfd == 0) {
          continue;
        }

      newFd = ClientP__Transport__accept(ClientP__server[sim_node()][i].sockfd);
      if (newFd > 0) {
          if (ClientP__server[sim_node()][i].numConns < MAX_NUM_OF_SOCKETS - 1) {
              ClientP__server[sim_node()][i].conns[ClientP__server[sim_node()][i].numConns++] = newFd;
            }
        }
      for (j = 0; j < ClientP__server[sim_node()][i].numConns; j++) {
          if (ClientP__server[sim_node()][i].conns[j] != 0) {
              if (ClientP__serverAvailable(i) > 0) {
                  length = ClientP__min(1024 - ClientP__server[sim_node()][i].bytesWritten, 10);
                  bytes += ClientP__Transport__read(ClientP__server[sim_node()][i].conns[j], &ClientP__server[sim_node()][i].buffer[ClientP__server[sim_node()][i].bytesWritten], length);
                  ClientP__server[sim_node()][i].bytesWritten += bytes;
                  if (ClientP__server[sim_node()][i].bytesWritten == 1024) {
                      ClientP__server[sim_node()][i].bytesWritten = 0;
                    }
                }
            }
      ...
      while (ClientP__serverOccupied(i) >= 2) {
          if (!isRead) {
              sim_log_debug(282U, TRANSPORT_CHANNEL, "Reading ACK Data at %u: ", ClientP__server[sim_node()][i].bytesRead);
              isRead = TRUE;
            }
          if (ClientP__server[sim_node()][i].bytesRead == 1024) {
              ClientP__server[sim_node()][i].bytesRead = 0;
            }
          data = ((uint16_t )ClientP__server[sim_node()][i].buffer[ClientP__server[sim_node()][i].bytesRead + 1] << 8) | (uint16_t )ClientP__server[sim_node()][i].buffer[ClientP__server[sim_node()][i].bytesRead];
          printf("%u,", data);
          ClientP__server[sim_node()][i].bytesRead += 2;
        }
      if (isRead) {
        printf("\n");
        }
...
#line 158
{
  ClientP__handleServer();
  ClientP__handleClient();
}
...
# 101 "lib/interfaces/Transport.nc"
inline static uint16_t ChatP__Transport__read(socket_t fd, uint8_t *buff, uint16_t bufflen){
#line 101
  unsigned short __nesc_result;
#line 101
...
#line 101
#line 74
inline static uint16_t ChatP__Transport__write(socket_t fd, uint8_t *buff, uint16_t bufflen){
#line 74
  unsigned short __nesc_result;
#line 74
...
#line 74
#line 57
inline static socket_t ChatP__Transport__accept(socket_t fd){
#line 57
  unsigned char __nesc_result;
#line 57
...
#line 277
  ...
  if (ChatP__startsWith(&ChatP__chatApp[sim_node()].connections[index].message[ChatP__chatApp[sim_node()].connections[index].RRead % 256], "hello ")) {
      i = 0;
      while (ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + 6 + i) % 256] != '\r') {
          ChatP__chatApp[sim_node()].connections[index].username[i] = ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + 6 + i) % 256];
          i++;
        }
      ChatP__chatApp[sim_node()].connections[index].username[i] = '\0';
      sim_log_debug(317U, CHAT_CHANNEL, "SERVER: Received hello from %s\n", ChatP__chatApp[sim_node()].connections[index].username);
      ChatP__chatApp[sim_node()].connections[index].RRead += 6 + i + 2;
    }
  else {
    if (ChatP__startsWith(&ChatP__chatApp[sim_node()].connections[index].message[ChatP__chatApp[sim_node()].connections[index].RRead % 256], "msg ")) {

        sim_log_debug(318U, CHAT_CHANNEL, "SERVER: Received msg from %s\n", ChatP__chatApp[sim_node()].connections[index].username);
        for (i = 0; i < 5; i++) {
            if (ChatP__chatApp[sim_node()].connections[i].writeFd > 0 && index != i) {
                j = 0;
                while (1) {
                    ChatP__chatApp[sim_node()].connections[i].sendBuffer[ChatP__chatApp[sim_node()].connections[i].sendWritten++ % 256] = ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + j) % 256];
                    if (j > 0 && ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + j) % 256] == '\n' && ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + j - 1) % 256] == '\r') {
                        break;
                      }
                    j++;
                  }
                sim_log_debug(319U, CHAT_CHANNEL, "SERVER: Broadcasting to %s\n", & ChatP__chatApp[sim_node()].connections[i].username);
              }
          }
        ChatP__chatApp[sim_node()].connections[index].RRead += j + 1;
      }
    else {
#line 308
      if (ChatP__startsWith(&ChatP__chatApp[sim_node()].connections[index].message[ChatP__chatApp[sim_node()].connections[index].RRead % 256], "whisper ")) {
          sim_log_debug(320U, CHAT_CHANNEL, "SERVER: Received whisper from %s\n", ChatP__chatApp[sim_node()].connections[index].username);

          for (i = 0; i < 5; i++) {
              if (ChatP__chatApp[sim_node()].connections[i].writeFd > 0 && ChatP__startsWith(&ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + 8) % 256], & ChatP__chatApp[sim_node()].connections[i].username)) {
                  sim_log_debug(321U, CHAT_CHANNEL, "SERVER: Found user %s\n", ChatP__chatApp[sim_node()].connections[i].username);
                  j = 0;
                  while (TRUE) {
                      ChatP__chatApp[sim_node()].connections[i].sendBuffer[ChatP__chatApp[sim_node()].connections[i].sendWritten++ % 256] = ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + j) % 256];
                      if (j > 0 && ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + j) % 256] == '\n' && ChatP__chatApp[sim_node()].connections[index].message[(ChatP__chatApp[sim_node()].connections[index].RRead + j - 1) % 256] == '\r') {
...
#line 326
        if (ChatP__startsWith(&ChatP__chatApp[sim_node()].connections[index].message[ChatP__chatApp[sim_node()].connections[index].RRead % 256], "listusr\r\n")) {
            sim_log_debug(322U, CHAT_CHANNEL, "SERVER: Received listusr from %s\n", ChatP__chatApp[sim_node()].connections[index].username);
            usrList[0] = (void *)0;
            strcat(usrList, "usrListReply");

            for (i = 0; i < 5; i++) {
                if (ChatP__chatApp[sim_node()].connections[i].readFd > 0 && ChatP__chatApp[sim_node()].connections[i].username[0] != (void *)0) {
                    strcat(usrList, " ");
                    strcat(usrList, ChatP__chatApp[sim_node()].connections[i].username);
                  }
              }
            ...
            while (j < strlen(usrList)) {
                ChatP__chatApp[sim_node()].connections[index].sendBuffer[ChatP__chatApp[sim_node()].connections[index].sendWritten++ % 256] = usrList[j++];
              }
            ChatP__chatApp[sim_node()].connections[index].RRead += 9;
          }
        }
      }
    }
...
inline static uint32_t ChatP__Transport__getConnectionDest(socket_t fd){
#line 149
  unsigned int __nesc_result;
#line 149

#line 149
  __nesc_result = TransportP__Transport__getConnectionDest(fd);
#line 149
...
#line 83
  ...
  if (ChatP__chatApp[sim_node()].state == ChatP__SERVER) {

      newReadFd = ChatP__Transport__accept(ChatP__chatApp[sim_node()].listenSockFd);
      if (newReadFd > 0) {
          for (i = 0; i < 5; i++) {
              if (ChatP__chatApp[sim_node()].connections[i].readFd == 0) {
                  ChatP__chatApp[sim_node()].connections[i].readFd = newReadFd;
                  ChatP__chatApp[sim_node()].connections[i].writeFd = ChatP__Transport__socket();
                  if (ChatP__chatApp[sim_node()].connections[i].writeFd == 0) {

                      sim_log_debug(303U, CHAT_CHANNEL, "Can't obtain socket. RIP!");
                      break;
                    }
                  __nesc_hton_uint16(addr.addr.nxdata, TOS_NODE_ID);
                  __nesc_hton_uint8(addr.port.nxdata, 100 + i);
                  if (ChatP__Transport__bind(ChatP__chatApp[sim_node()].connections[i].writeFd, &addr) == FAIL) {
                      sim_log_debug(304U, CHAT_CHANNEL, "Can't bind socket. RIP!");
                      break;
                    }

                  __nesc_hton_uint16(addr.addr.nxdata, ChatP__Transport__getConnectionDest(newReadFd));
                  __nesc_hton_uint8(addr.port.nxdata, 50);

                  sim_log_debug(305U, CHAT_CHANNEL, "Connecting back to client %u\n", __nesc_ntoh_uint16(addr.addr.nxdata));
                  if (ChatP__Transport__connect(ChatP__chatApp[sim_node()].connections[i].writeFd, &addr) == FAIL) {
                      sim_log_debug(306U, CHAT_CHANNEL, "Can't connect to Server. RIP!");
                      break;
                    }
                  ChatP__chatApp[sim_node()].connections[i].sendRead = 0;
                  ChatP__chatApp[sim_node()].connections[i].sendWritten = 0;
                  break;
                }
            }
        }
      ...
      for (i = 0; i < 5; i++) {
          if (ChatP__chatApp[sim_node()].connections[i].readFd != 0) {
              ...
              bytes = 1;
              while (ChatP__getRBufferAvailable(i) > 0 && bytes > 0) {
                  bytes = ChatP__Transport__read(ChatP__chatApp[sim_node()].connections[i].readFd, &ChatP__chatApp[sim_node()].connections[i].message[ChatP__chatApp[sim_node()].connections[i].RWritten % 256], 1);

                  if (ChatP__chatApp[sim_node()].connections[i].message[ChatP__chatApp[sim_node()].connections[i].RWritten % 256] == '\n' && ChatP__chatApp[sim_node()].connections[i].message[(ChatP__chatApp[sim_node()].connections[i].RWritten - 1) % 256] == '\r') {
                      ChatP__chatApp[sim_node()].connections[i].message[ChatP__chatApp[sim_node()].connections[i].RWritten + 1 % 256] = '\0';

                      ChatP__getCommand(i);
                    }
                  ChatP__chatApp[sim_node()].connections[i].RWritten += bytes;
                }
            }

          if (ChatP__chatApp[sim_node()].connections[i].writeFd != 0) {
              bytes = 1;
              while (ChatP__getSBufferOccupied(i) > 0 && bytes > 0) {
                  bytes = ChatP__Transport__write(ChatP__chatApp[sim_node()].connections[i].writeFd, &ChatP__chatApp[sim_node()].connections[i].sendBuffer[ChatP__chatApp[sim_node()].connections[i].sendRead % 256], 1);


                  ChatP__chatApp[sim_node()].connections[i].sendRead += bytes;
                }
            }
        }
    }
      ...
      newReadFd = ChatP__Transport__accept(ChatP__chatApp[sim_node()].listenSockFd);
      if (newReadFd > 0 && ChatP__chatApp[sim_node()].connections[0].readFd == 0) {
          sim_log_debug(307U, CHAT_CHANNEL, "CLIENT: server return connection is set up with socket %u\n", newReadFd);
          ChatP__chatApp[sim_node()].connections[0].readFd = newReadFd;
          ChatP__chatApp[sim_node()].connections[0].RRead = 0;
          ChatP__chatApp[sim_node()].connections[0].RWritten = 0;
        }
      else 
#line 156
        {

          if (ChatP__getSBufferOccupied(0) > 0) {

              bytes = ChatP__Transport__write(ChatP__chatApp[sim_node()].connections[0].writeFd, &ChatP__chatApp[sim_node()].connections[0].sendBuffer[ChatP__chatApp[sim_node()].connections[0].sendRead % 256], ChatP__getSBufferOccupied(0));
              ChatP__chatApp[sim_node()].connections[0].sendRead += bytes;
            }

          bytes = 1;
          while (ChatP__getRBufferAvailable(0) > 0 && bytes > 0) {
              bytes = ChatP__Transport__read(ChatP__chatApp[sim_node()].connections[0].readFd, &ChatP__chatApp[sim_node()].connections[0].message[ChatP__chatApp[sim_node()].connections[0].RWritten % 256], 1);

              if (ChatP__chatApp[sim_node()].connections[0].message[ChatP__chatApp[sim_node()].connections[0].RWritten % 256] == '\n' && ChatP__chatApp[sim_node()].connections[0].message[(ChatP__chatApp[sim_node()].connections[0].RWritten - 1) % 256] == '\r') {
                  ChatP__chatApp[sim_node()].connections[0].message[ChatP__chatApp[sim_node()].connections[0].RWritten % 256] = '\0';
                  sim_log_debug(308U, CHAT_CHANNEL, "CLIENT: %s\n", &ChatP__chatApp[sim_node()].connections[0].message[ChatP__chatApp[sim_node()].connections[0].RRead % 256]);
                  ChatP__chatApp[sim_node()].connections[0].RRead = ChatP__chatApp[sim_node()].connections[0].RWritten + 1;
                }
              ChatP__chatApp[sim_node()].connections[0].RWritten += bytes;
            }
        }
    }
}
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fc248d26950){
#line 83
  switch (arg_0x7fc248d26950) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 2U:
#line 83
      /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__fired();
#line 83
      break;
#line 83
    case 3U:
...
#line 83
    case 4U:
#line 83
      /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__fired();
#line 83
      break;
#line 83
    case 5U:
#line 83
      TransportP__TransmissionTimer__fired();
#line 83
      break;
#line 83
    case 6U:
#line 83
      /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__fired();
#line 83
      break;
#line 83
    case 7U:
#line 83
      ClientP__ClientTimer__fired();
#line 83
      break;
#line 83
    case 8U:
...
#line 83
    case 9U:
#line 83
      ChatP__ChatTimer__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fc248d26950);
#line 83
      break;
#line 83
    }
...
#line 91
              sim_log_debug(273U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(274U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*TransportC.SocketMap*/HashmapC__1__keys[sim_node()][j], /*TransportC.SocketMap*/HashmapC__1__keys[sim_node()][j + 1]);
              /*TransportC.SocketMap*/HashmapC__1__keys[sim_node()][j] = /*TransportC.SocketMap*/HashmapC__1__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(275U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}

# 680 "lib/modules/TransportP.nc"
static inline uint16_t TransportP__getSendBufferAvailable(uint8_t fd)
#line 680
{
  uint8_t lastAck;
...
#line 67
  for (i = 0; i < 20; i++) {
      /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[sim_node()][i] = &/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[sim_node()][i];
    }
  /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[sim_node()] = 20;
  /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[sim_node()] = 0;
  return SUCCESS;
}
...
#line 67
  for (i = 0; i < 20; i++) {
      /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__queue[sim_node()][i] = &/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool[sim_node()][i];
    }
  /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[sim_node()] = 20;
  /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__index[sim_node()] = 0;
  return SUCCESS;
}
...
#line 67
  for (i = 0; i < 20; i++) {
      /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__queue[sim_node()][i] = &/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool[sim_node()][i];
    }
  /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[sim_node()] = 20;
  /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__index[sim_node()] = 0;
  return SUCCESS;
}
...
#line 67
  for (i = 0; i < 20; i++) {
      /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__queue[sim_node()][i] = &/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool[sim_node()][i];
    }
  /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[sim_node()] = 20;
  /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__index[sim_node()] = 0;
  return SUCCESS;
}
...
#line 62
  __nesc_result = /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__Init__init();
#line 62
  __nesc_result = ecombine(__nesc_result, /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__Init__init());
#line 62
  __nesc_result = ecombine(__nesc_result, /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__Init__init());
#line 62
  __nesc_result = ecombine(__nesc_result, /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__Init__init());
#line 62
...
#line 182
  if (ChatP__chatApp[sim_node()].state == ChatP__CLIENT || ChatP__chatApp[sim_node()].listenSockFd > 0) {
      sim_log_debug(309U, CHAT_CHANNEL, "RIP Server\n");
      return;
    }
  ChatP__chatApp[sim_node()].state = ChatP__SERVER;
  ChatP__chatApp[sim_node()].listenSockFd = ChatP__Transport__socket();
  if (ChatP__chatApp[sim_node()].listenSockFd > 0) {
...
inline static void Node__Chat__startChatServer(void ){
#line 6
  ChatP__Chat__startChatServer();
#line 6
}
#line 6
# 73 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void TransportP__TransmissionTimer__startOneShot(uint32_t dt){
#line 73
...
#line 53
  TransportP__TransmissionTimer__startOneShot(60 * 1024);
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      TransportP__resetSocket(i + 1);
    }
}
...
#line 73
# 366 "lib/modules/DistanceVectorRoutingP.nc"
static inline void DistanceVectorRoutingP__initilizeRoutingTable(void )
#line 366
{
...
#line 224
{
  ...
  sim_log_debug(195U, ROUTING_CHANNEL, "Distance Vector Routing Started on node %u!\n", TOS_NODE_ID);
}
...
#line 24
{
  ...
  sim_log_debug(136U, NEIGHBOR_CHANNEL, "Neighbor Discovery Started on node %u!\n", TOS_NODE_ID);
}
...
# 370 "lib/modules/DistanceVectorRoutingP.nc"
static void DistanceVectorRoutingP__addRoute(uint8_t dest, uint8_t nextHop, uint8_t dist, uint8_t ttl)
#line 370
{

  if (DistanceVectorRoutingP__numRoutes[sim_node()] != 25) {
      ...
      DistanceVectorRoutingP__routingTable[sim_node()][DistanceVectorRoutingP__numRoutes[sim_node()]].dist = dist;
...
#line 452
{
  ...
  uint32_t *neighbors = DistanceVectorRoutingP__NeighborDiscovery__Neighbors_list();
  uint16_t neighborsListSize = DistanceVectorRoutingP__NeighborDiscovery__Neighbors_num();
  uint8_t i = 0;
#line 456
  uint8_t j = 0;
#line 456
  ...
  for (i = 0; i < neighborsListSize; i++) {
      while (j < DistanceVectorRoutingP__numRoutes[sim_node()]) {
          ...
          if (neighbors[i] == DistanceVectorRoutingP__routingTable[sim_node()][j].nextHop && 1 == 0) {
...
#line 475
            if (neighbors[i] == DistanceVectorRoutingP__routingTable[sim_node()][j].nextHop && 1 == 1) {
                temp = DistanceVectorRoutingP__routingTable[sim_node()][j].dist;
                DistanceVectorRoutingP__routingTable[sim_node()][j].dist = 18;
                isSwapped = TRUE;
              }
            }
          ...
          packetRoutes[counter].dist = DistanceVectorRoutingP__routingTable[sim_node()][j].dist;
          counter++;
...
#line 501
            if (isSwapped && 1 == 1) {
                DistanceVectorRoutingP__routingTable[sim_node()][j].dist = temp;
              }
            }
#line 504
          isSwapped = FALSE;
...
#line 49
{
  ...
  if (!/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__empty()) {
      sendInfo *input;

      input = /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Pool__get();
      input->packet = msg;
      input->dest = dest;



      /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Queue__enqueue(input);
...
#line 76
  sim_log_debug(216U, "QueueC", "head <-");
  for (i = /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[sim_node()]; i < /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[sim_node()] + /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[sim_node()]; i++) {
      sim_log_debug_clear(217U, "QueueC", "[");
      for (j = 0; j < sizeof(/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue[sim_node()][i % 20])[j];

#line 81
          sim_log_debug_clear(218U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(219U, "QueueC", "] ");
    }
  sim_log_debug_clear(220U, "QueueC", "<- tail\n");
}
...
#line 38
{
  ...
  if (/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__isRunning() == FALSE) {

      /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__sendTimer__startOneShot(/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__Random__rand16() % 300);
    }
}
...
#line 42
  ...
  if (k == /*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[sim_node()]) {
      sim_log_debug(189U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[sim_node()]);
      return;
    }
  ...
  do {
      ...
      if (/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].key == /*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[sim_node()] || /*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].key == k) {


          if (/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].key == /*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[sim_node()]) {
              /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[sim_node()][/*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[sim_node()]] = k;
              /*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[sim_node()]++;
            }


          /*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].value = input;
          /*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].key = k;
          return;
        }
      i++;
    }
...
# 415 "lib/modules/DistanceVectorRoutingP.nc"
static bool DistanceVectorRoutingP__inputNeighbors(void )
#line 415
{
  uint32_t *neighbors = DistanceVectorRoutingP__NeighborDiscovery__Neighbors_list();
  ...
  for (i = 0; i < neighborsListSize; i++) {
      for (j = 1; j < DistanceVectorRoutingP__numRoutes[sim_node()]; j++) {
          ...
          if (neighbors[i] == DistanceVectorRoutingP__routingTable[sim_node()][j].dest) {
              ...
              DistanceVectorRoutingP__routingTable[sim_node()][j].dist = 1;
              DistanceVectorRoutingP__routingTable[sim_node()][j].ttl = 4;
              routeFound = TRUE;
              break;
            }
      ...
      if (!routeFound && DistanceVectorRoutingP__numRoutes[sim_node()] != 25) {
...
#line 435
        if (DistanceVectorRoutingP__numRoutes[sim_node()] == 25) {
            sim_log_debug(208U, ROUTING_CHANNEL, "Routing table full. Cannot add entry for node: %u\n", neighbors[i]);
          }
        }
#line 438
      routeFound = FALSE;
...
#line 252
  if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID && __nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
      sim_log_debug(197U, ROUTING_CHANNEL, "PING Packet has reached destination %d!!!\n", TOS_NODE_ID);
...
#line 257
    if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID && __nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PINGREPLY) {
        sim_log_debug(198U, ROUTING_CHANNEL, "PING_REPLY Packet has reached destination %d!!!\n", TOS_NODE_ID);
        return;
      }
    else {
#line 260
      if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID && __nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_TCP) {
          sim_log_debug(199U, ROUTING_CHANNEL, "TCP Packet has reached destination %d!!!\n", TOS_NODE_ID);
          DistanceVectorRoutingP__Transport__receive(myMsg);
          return;
        }
      }
    }
#line 265
  if ((nextHop = DistanceVectorRoutingP__findNextHop(__nesc_ntoh_uint16(myMsg->dest.nxdata)))) {
      sim_log_debug(200U, ROUTING_CHANNEL, "Node %d routing packet through %d\n", TOS_NODE_ID, nextHop);
...
#line 269
    {
      sim_log_debug(201U, ROUTING_CHANNEL, "No route to destination. Dropping packet...\n");
    }
}

# 632 "lib/modules/TransportP.nc"
static uint8_t TransportP__findSocket(uint8_t src, uint8_t srcPort, uint8_t dest, uint8_t destPort)
#line 632
{
...
#line 634
  return TransportP__SocketMap__get(id);
}
...
#line 692
  ...
  lastRcvd = TransportP__sockets[sim_node()][fd - 1].lastRcvd % SOCKET_BUFFER_SIZE;
...
#line 743
  ...
  __nesc_hton_uint8(TransportP__tcpPack[sim_node()].srcPort.nxdata, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata));
  __nesc_hton_uint8(TransportP__tcpPack[sim_node()].destPort.nxdata, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata));
  __nesc_hton_uint8(TransportP__tcpPack[sim_node()].flags.nxdata, flags);
  __nesc_hton_uint8(TransportP__tcpPack[sim_node()].advertisedWindow.nxdata, TransportP__calAdv(fd));
  __nesc_hton_uint16(TransportP__tcpPack[sim_node()].ack.nxdata, TransportP__sockets[sim_node()][fd - 1].nextExpected);


  if (flags == SYN) {
      sim_log_debug(249U, TRANSPORT_CHANNEL, "Sending SYN to port %u on node %u\n", __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata), __nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].dest.addr.nxdata));
      __nesc_hton_uint16(TransportP__tcpPack[sim_node()].seq.nxdata, TransportP__sockets[sim_node()][fd - 1].lastSent);
    }
  else 
#line 756
    {
      __nesc_hton_uint16(TransportP__tcpPack[sim_node()].seq.nxdata, TransportP__sockets[sim_node()][fd - 1].lastSent + 1);
    }
  if (flags == DATA) {

      length = TransportP__min(TransportP__min(TransportP__calEFF(fd), TransportP__calCong(fd) - TransportP__getSDatainFlight(fd)), TransportP__min(TransportP__getSendBufferOccupied(fd), 5 * sizeof(nx_uint16_t )));
      if (length == 0) {
          return 0;
        }
      while (bytes < length) {
          memcpy(payload + bytes, &TransportP__sockets[sim_node()][fd - 1].sendBuff[++ TransportP__sockets[sim_node()][fd - 1].lastSent % SOCKET_BUFFER_SIZE], 1);
          bytes += 1;
        }
      __nesc_hton_uint8(TransportP__tcpPack[sim_node()].length.nxdata, length);
    }
  TransportP__makePack(&TransportP__packet[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].dest.addr.nxdata), BETTER_TTL, PROTOCOL_TCP, 0, &TransportP__tcpPack[sim_node()], sizeof(tcp_pack ));
  TransportP__DistanceVectorRouting__routePacket(&TransportP__packet[sim_node()]);
  return bytes;
}
...
#line 711
{
  return TransportP__sockets[sim_node()][fd - 1].cwnd * 5 * sizeof(nx_uint16_t ) + TransportP__sockets[sim_node()][fd - 1].cwndRemainder * 5 * sizeof(nx_uint16_t ) / TransportP__sockets[sim_node()][fd - 1].cwnd;
}
...
#line 718
{
  uint32_t now = TransportP__TransmissionTimer__getNow();

#line 720
  if (TransportP__sockets[sim_node()][fd - 1].RTT_SEQ == ack && TransportP__sockets[sim_node()][fd - 1].IS_VALID_RTT) {
      sim_log_debug(246U, TRANSPORT_CHANNEL, "Sample RTT: %u,\n", TransportP__sockets[sim_node()][fd - 1].RTT);


      TransportP__sockets[sim_node()][fd - 1].RTT = (80 * TransportP__sockets[sim_node()][fd - 1].RTT + (100 - 80) * (now - TransportP__sockets[sim_node()][fd - 1].RTX)) / 100;
      TransportP__sockets[sim_node()][fd - 1].RTT_VAR = (75 * TransportP__sockets[sim_node()][fd - 1].RTT_VAR + (100 - 75) * TransportP__absolute(TransportP__sockets[sim_node()][fd - 1].RTT_VAR, now - TransportP__sockets[sim_node()][fd - 1].RTX)) / 100;
      sim_log_debug(247U, TRANSPORT_CHANNEL, "Estimated RTT: %u\n", TransportP__sockets[sim_node()][fd - 1].RTT);
      sim_log_debug(248U, TRANSPORT_CHANNEL, "TimeOut: %u\n", TransportP__sockets[sim_node()][fd - 1].RTT * 2);
    }
  else {
#line 728
...
#line 777
{
  uint16_t bytesRemaining = TransportP__min(TransportP__calCong(fd) - TransportP__getSDatainFlight(fd), TransportP__min(TransportP__getSendBufferOccupied(fd), TransportP__calEFF(fd)));
  uint8_t bytesSent;
  bool firstPacket = TRUE;

#line 781
  while (bytesRemaining > 0 && bytesSent > 0 && TransportP__calCong(fd) > TransportP__getSDatainFlight(fd)) {
...
#line 734
{
  ...
  TransportP__sockets[sim_node()][fd - 1].RTX = TransportP__TransmissionTimer__getNow();
...
#line 867
  ...
  TransportP__sockets[sim_node()][fd - 1].RTT = 2048;
  TransportP__sockets[sim_node()][fd - 1].RTT_VAR = 512;
  TransportP__sockets[sim_node()][fd - 1].RTO = 1024;
  ...
  TransportP__sockets[sim_node()][fd - 1].ssthresh = 18 * 5 * sizeof(nx_uint16_t );
  TransportP__sockets[sim_node()][fd - 1].dupAck.seq = 0;
  TransportP__sockets[sim_node()][fd - 1].dupAck.count = 0;
  TransportP__sockets[sim_node()][fd - 1].deadlockAck = FALSE;
}
...
#line 42
  ...
  if (k == /*TransportC.SocketMap*/HashmapC__1__EMPTY_KEY[sim_node()]) {
      sim_log_debug(270U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*TransportC.SocketMap*/HashmapC__1__EMPTY_KEY[sim_node()]);
      return;
    }
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fc248c74940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fc248c74940) {
#line 100
    case 0U:
#line 100
...
#line 100
    case 1U:
#line 100
      /*DistanceVectorRoutingC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    case 2U:
#line 100
      /*TransportC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    case 3U:
#line 100
      /*ClientC.SimpleSendC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__3__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    case 4U:
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fc248c74940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 38
{
  ...
  if (/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__isRunning() == FALSE) {

      /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__sendTimer__startOneShot(/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__Random__rand16() % 300);
    }
}
...
#line 38
{
  ...
  if (/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__isRunning() == FALSE) {

      /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__sendTimer__startOneShot(/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__Random__rand16() % 300);
    }
}
...
#line 190
  ...
  for (i = 0; i < MAX_NUM_OF_SOCKETS - 1; i++) {
      ...
      if (TransportP__sockets[sim_node()][fd - 1].connectionQueue[i] != 0) {
          conn = TransportP__sockets[sim_node()][fd - 1].connectionQueue[i];
          while (++i < MAX_NUM_OF_SOCKETS - 1 && TransportP__sockets[sim_node()][fd - 1].connectionQueue[i] != 0) {
...
#line 133
  for (i = 0; i < MAX_NUM_OF_SOCKETS; i++) {
      ...
      if (TransportP__sockets[sim_node()][i].state == CLOSED) {
          TransportP__sockets[sim_node()][i].state = OPENED;
...
#line 159
  ...
  if (TransportP__sockets[sim_node()][fd - 1].state == OPENED && !TransportP__ports[sim_node()][__nesc_ntoh_uint8(addr->port.nxdata)]) {
      ...
      TransportP__sockets[sim_node()][fd - 1].state = NAMED;
      id = ((uint32_t )__nesc_ntoh_uint16(addr->addr.nxdata) << 24) | ((uint32_t )__nesc_ntoh_uint8(addr->port.nxdata) << 16);
      TransportP__SocketMap__insert(id, fd);
...
#line 472
  if ((fd == 0 || fd > MAX_NUM_OF_SOCKETS) || TransportP__sockets[sim_node()][fd - 1].state != NAMED) {
      return FAIL;
    }

  id = ((uint32_t )__nesc_ntoh_uint16(TransportP__sockets[sim_node()][fd - 1].src.addr.nxdata) << 24) | ((uint32_t )__nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata) << 16);
  TransportP__SocketMap__remove(id);
  __nesc_hton_uint16(TransportP__sockets[sim_node()][fd - 1].dest.addr.nxdata, __nesc_ntoh_uint16(dest->addr.nxdata));
  __nesc_hton_uint8(TransportP__sockets[sim_node()][fd - 1].dest.port.nxdata, __nesc_ntoh_uint8(dest->port.nxdata));
  TransportP__sockets[sim_node()][fd - 1].type = CLIENT;

  TransportP__sendTCPPacket(fd, SYN);
  TransportP__calcRTO(fd);

  id |= ((uint32_t )__nesc_ntoh_uint16(dest->addr.nxdata) << 8) | (uint32_t )__nesc_ntoh_uint8(dest->port.nxdata);
  TransportP__SocketMap__insert(id, fd);

  TransportP__sockets[sim_node()][fd - 1].state = SYN_SENT;
  sim_log_debug(243U, TRANSPORT_CHANNEL, "SYN sent to port %u to node %u by node %u via port %u\n", __nesc_ntoh_uint8(dest->port.nxdata), __nesc_ntoh_uint16(dest->addr.nxdata), TOS_NODE_ID, __nesc_ntoh_uint8(TransportP__sockets[sim_node()][fd - 1].src.port.nxdata));
  return SUCCESS;
}
...
# 347 "lib/modules/ChatP.nc"
static uint16_t ChatP__getRBufferAvailable(uint8_t i)
#line 347
{
  if (ChatP__chatApp[sim_node()].connections[i].RRead <= ChatP__chatApp[sim_node()].connections[i].RWritten) {
    return 256 - ChatP__chatApp[sim_node()].connections[i].RWritten % 256 + ChatP__chatApp[sim_node()].connections[i].RRead % 256 - 1;
    }
  else {
#line 351
    return ChatP__chatApp[sim_node()].connections[i].RRead % 256 - ChatP__chatApp[sim_node()].connections[i].RWritten % 256 - 1;
    }
}

# 440 "lib/modules/TransportP.nc"
static uint16_t TransportP__Transport__read(socket_t fd, uint8_t *buff, uint16_t bufflen)
#line 440
{
  uint16_t read = 0;
...
#line 442
  if ((fd == 0 || fd > MAX_NUM_OF_SOCKETS) || TransportP__sockets[sim_node()][fd - 1].state != ESTABLISHED) {
      return 0;
    }

  while (read < bufflen && TransportP__getRreadable(fd) > 0) {
      memcpy(buff, &TransportP__sockets[sim_node()][fd - 1].rcvdBuff[++ TransportP__sockets[sim_node()][fd - 1].lastRead % SOCKET_BUFFER_SIZE], 1);
      buff++;
      read++;
    }
...
#line 368
{
  if (ChatP__chatApp[sim_node()].connections[i].sendRead <= ChatP__chatApp[sim_node()].connections[i].sendWritten) {
    return ChatP__chatApp[sim_node()].connections[i].sendWritten % 256 - ChatP__chatApp[sim_node()].connections[i].sendRead % 256;
    }
  else {
#line 372
    return 256 - ChatP__chatApp[sim_node()].connections[i].sendRead % 256 + ChatP__chatApp[sim_node()].connections[i].sendWritten % 256;
    }
}

# 223 "lib/modules/TransportP.nc"
static uint16_t TransportP__Transport__write(socket_t fd, uint8_t *buff, uint16_t bufflen)
#line 223
{
...
#line 225
  ...
  while (bytesWritten < bufflen && TransportP__getSendBufferAvailable(fd) > 0) {
      memcpy(&TransportP__sockets[sim_node()][fd - 1].sendBuff[++ TransportP__sockets[sim_node()][fd - 1].lastWritten % SOCKET_BUFFER_SIZE], buff + bytesWritten, 1);
      bytesWritten++;
    }
...
# 259 "lib/modules/ClientP.nc"
static uint16_t ClientP__serverOccupied(uint8_t x)
#line 259
{
  if (ClientP__server[sim_node()][x].bytesRead == ClientP__server[sim_node()][x].bytesWritten) {
      return 0;
    }
  else {
#line 262
    if (ClientP__server[sim_node()][x].bytesRead < ClientP__server[sim_node()][x].bytesWritten) {
        return ClientP__server[sim_node()][x].bytesWritten - ClientP__server[sim_node()][x].bytesRead;
      }
    else 
#line 264
      {
        return 1024 - ClientP__server[sim_node()][x].bytesRead + ClientP__server[sim_node()][x].bytesWritten;
      }
    }
}
...
#line 274
{
  if (ClientP__client[sim_node()][x].bytesTransferred == ClientP__client[sim_node()][x].bytesWritten) {
      return 0;
    }
  else {
#line 277
    if (ClientP__client[sim_node()][x].bytesTransferred < ClientP__client[sim_node()][x].bytesWritten) {
        return ClientP__client[sim_node()][x].bytesWritten - ClientP__client[sim_node()][x].bytesTransferred;
      }
    else 
#line 279
      {
        return 1024 - ClientP__client[sim_node()][x].bytesTransferred + ClientP__client[sim_node()][x].bytesWritten;
      }
    }
}
...
{
  uint16_t i;
  uint32_t *neighbors = NeighborDiscoveryP__NeighborDiscovery__Neighbors_list();

  sim_log_debug(140U, NEIGHBOR_CHANNEL, "---Listing Neighbors of Node %d---\n", TOS_NODE_ID);
  for (i = 0; i < NeighborDiscoveryP__NeighborDiscovery__Neighbors_num(); i++) {
      if (neighbors[i] != TOS_NODE_ID) 
        {
          sim_log_debug(141U, NEIGHBOR_CHANNEL, "%d\n", neighbors[i]);
        }
    }

  sim_log_debug(142U, NEIGHBOR_CHANNEL, "----------------------------------\n");
}
...
#line 132
  do {
      j = /*NeighborDiscoveryC.Neighbors*/HashmapC__0__hash(k, i);
      if (/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].key == k) {
        return /*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][j].value;
        }
#line 136
      i++;
    }
...
#line 137
  ...
  return /*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[sim_node()][0].value;
}
...
#line 42
  ...
  if (k == /*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[sim_node()]) {
      sim_log_debug(297U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[sim_node()]);
      return;
    }
  ...
  do {
      ...
      if (/*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].key == /*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[sim_node()] || /*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].key == k) {


          if (/*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].key == /*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[sim_node()]) {
              /*ClientC.HashmapC*/HashmapC__2__keys[sim_node()][/*ClientC.HashmapC*/HashmapC__2__numofVals[sim_node()]] = k;
              /*ClientC.HashmapC*/HashmapC__2__numofVals[sim_node()]++;
            }


          /*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].value = input;
          /*ClientC.HashmapC*/HashmapC__2__map[sim_node()][j].key = k;
          return;
        }
      i++;
    }
...
#line 570
{
  ...
  if (TransportP__sockets[sim_node()][fd - 1].state == NAMED) {

      TransportP__sockets[sim_node()][fd - 1].state = LISTEN;
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module HashmapC__0 */
  if (!strcmp(varname, "/*NeighborDiscoveryC.Neighbors*/HashmapC__0__HASH_MAX_SIZE"))
  {
    *addr = (uintptr_t)&/*NeighborDiscoveryC.Neighbors*/HashmapC__0__HASH_MAX_SIZE[__nesc_mote];
    *size = sizeof(/*NeighborDiscoveryC.Neighbors*/HashmapC__0__HASH_MAX_SIZE[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY"))
  {
    *addr = (uintptr_t)&/*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[__nesc_mote];
    *size = sizeof(/*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map"))
  {
    *addr = (uintptr_t)&/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[__nesc_mote];
    *size = sizeof(/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys"))
  {
    *addr = (uintptr_t)&/*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[__nesc_mote];
    *size = sizeof(/*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals"))
  {
    *addr = (uintptr_t)&/*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[__nesc_mote];
    *size = sizeof(/*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[__nesc_mote]);
    return 0;
  }
  ...
  /* Module PoolP__2 */
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[__nesc_mote]);
    return 0;
  }

  /* Module QueueC__2 */
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size"))
  {
    *addr = (uintptr_t)&/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[__nesc_mote];
    *size = sizeof(/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[__nesc_mote]);
    return 0;
  }

  /* Module TransportP */
  if (!strcmp(varname, "TransportP__packet"))
  {
    *addr = (uintptr_t)&TransportP__packet[__nesc_mote];
    *size = sizeof(TransportP__packet[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt[__nesc_mote]);
    return 0;
  }
  ...
  /* Module PoolP__3 */
  if (!strcmp(varname, "/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__index"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__index[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__queue"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__queue[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool[__nesc_mote]);
    return 0;
  }

  /* Module QueueC__3 */
  if (!strcmp(varname, "/*TransportC.SimpleSendC.QueueC*/QueueC__3__queue"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.QueueC*/QueueC__3__queue[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.QueueC*/QueueC__3__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.SimpleSendC.QueueC*/QueueC__3__head"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.QueueC*/QueueC__3__head[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.QueueC*/QueueC__3__head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*TransportC.SimpleSendC.QueueC*/QueueC__3__size"))
  {
    *addr = (uintptr_t)&/*TransportC.SimpleSendC.QueueC*/QueueC__3__size[__nesc_mote];
    *size = sizeof(/*TransportC.SimpleSendC.QueueC*/QueueC__3__size[__nesc_mote]);
    return 0;
  }
  ...
  /* Module ClientP */
  if (!strcmp(varname, "ClientP__server"))
  {
    *addr = (uintptr_t)&ClientP__server[__nesc_mote];
    *size = sizeof(ClientP__server[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ClientP__client"))
  {
    *addr = (uintptr_t)&ClientP__client[__nesc_mote];
    *size = sizeof(ClientP__client[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ClientP__numServers"))
  {
    *addr = (uintptr_t)&ClientP__numServers[__nesc_mote];
    *size = sizeof(ClientP__numServers[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ClientP__numClients"))
  {
    *addr = (uintptr_t)&ClientP__numClients[__nesc_mote];
    *size = sizeof(ClientP__numClients[__nesc_mote]);
    return 0;
  }

  /* Module SimpleSendP__3 */
  if (!strcmp(varname, "/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt[__nesc_mote]);
    return 0;
  }
  ...
  /* Module PoolP__4 */
  if (!strcmp(varname, "/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__index"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__index[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__queue"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__queue[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool[__nesc_mote]);
    return 0;
  }

  /* Module QueueC__4 */
  if (!strcmp(varname, "/*ClientC.SimpleSendC.QueueC*/QueueC__4__queue"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.QueueC*/QueueC__4__queue[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.QueueC*/QueueC__4__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.SimpleSendC.QueueC*/QueueC__4__head"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.QueueC*/QueueC__4__head[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.QueueC*/QueueC__4__head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.SimpleSendC.QueueC*/QueueC__4__size"))
  {
    *addr = (uintptr_t)&/*ClientC.SimpleSendC.QueueC*/QueueC__4__size[__nesc_mote];
    *size = sizeof(/*ClientC.SimpleSendC.QueueC*/QueueC__4__size[__nesc_mote]);
    return 0;
  }

  /* Module HashmapC__2 */
  if (!strcmp(varname, "/*ClientC.HashmapC*/HashmapC__2__HASH_MAX_SIZE"))
  {
    *addr = (uintptr_t)&/*ClientC.HashmapC*/HashmapC__2__HASH_MAX_SIZE[__nesc_mote];
    *size = sizeof(/*ClientC.HashmapC*/HashmapC__2__HASH_MAX_SIZE[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY"))
  {
    *addr = (uintptr_t)&/*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[__nesc_mote];
    *size = sizeof(/*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.HashmapC*/HashmapC__2__map"))
  {
    *addr = (uintptr_t)&/*ClientC.HashmapC*/HashmapC__2__map[__nesc_mote];
    *size = sizeof(/*ClientC.HashmapC*/HashmapC__2__map[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.HashmapC*/HashmapC__2__keys"))
  {
    *addr = (uintptr_t)&/*ClientC.HashmapC*/HashmapC__2__keys[__nesc_mote];
    *size = sizeof(/*ClientC.HashmapC*/HashmapC__2__keys[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ClientC.HashmapC*/HashmapC__2__numofVals"))
  {
    *addr = (uintptr_t)&/*ClientC.HashmapC*/HashmapC__2__numofVals[__nesc_mote];
    *size = sizeof(/*ClientC.HashmapC*/HashmapC__2__numofVals[__nesc_mote]);
    return 0;
  }

  /* Module ChatP */
  if (!strcmp(varname, "ChatP__chatApp"))
  {
    *addr = (uintptr_t)&ChatP__chatApp[__nesc_mote];
    *size = sizeof(ChatP__chatApp[__nesc_mote]);
    return 0;
  }
  ...
  /* Module PoolP__5 */
  if (!strcmp(varname, "/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free"))
  {
    *addr = (uintptr_t)&/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[__nesc_mote];
    *size = sizeof(/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__index"))
  {
    *addr = (uintptr_t)&/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__index[__nesc_mote];
    *size = sizeof(/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__queue"))
  {
    *addr = (uintptr_t)&/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__queue[__nesc_mote];
    *size = sizeof(/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool"))
  {
    *addr = (uintptr_t)&/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool[__nesc_mote];
    *size = sizeof(/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module HashmapC__0 */
  /*NeighborDiscoveryC.Neighbors*/HashmapC__0__HASH_MAX_SIZE[__nesc_mote] = 20;
  /*NeighborDiscoveryC.Neighbors*/HashmapC__0__EMPTY_KEY[__nesc_mote] = 0;
  memset((void *)&/*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[__nesc_mote], 0, sizeof /*NeighborDiscoveryC.Neighbors*/HashmapC__0__map[__nesc_mote]);
  memset((void *)&/*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[__nesc_mote], 0, sizeof /*NeighborDiscoveryC.Neighbors*/HashmapC__0__keys[__nesc_mote]);
  memset((void *)&/*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[__nesc_mote], 0, sizeof /*NeighborDiscoveryC.Neighbors*/HashmapC__0__numofVals[__nesc_mote]);
  ...
  /* Module SimpleSendP__1 */
  /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__busy[__nesc_mote] = FALSE;
  memset((void *)&/*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[__nesc_mote], 0, sizeof /*DistanceVectorRoutingC.SimpleSendC.SimpleSendP*/SimpleSendP__1__pkt[__nesc_mote]);

  /* Module AMQueueEntryP__1 */

  /* Module PoolP__2 */
  memset((void *)&/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[__nesc_mote], 0, sizeof /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__free[__nesc_mote]);
  memset((void *)&/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[__nesc_mote], 0, sizeof /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__index[__nesc_mote]);
  memset((void *)&/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[__nesc_mote], 0, sizeof /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__queue[__nesc_mote]);
  memset((void *)&/*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[__nesc_mote], 0, sizeof /*DistanceVectorRoutingC.SimpleSendC.PoolC.PoolP*/PoolP__2__pool[__nesc_mote]);

  /* Module QueueC__2 */
  memset((void *)&/*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue[__nesc_mote], 0, sizeof /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__queue[__nesc_mote]);
  /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__head[__nesc_mote] = 0;
  /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__tail[__nesc_mote] = 0;
  /*DistanceVectorRoutingC.SimpleSendC.QueueC*/QueueC__2__size[__nesc_mote] = 0;

  /* Module TransportP */
  memset((void *)&TransportP__packet[__nesc_mote], 0, sizeof TransportP__packet[__nesc_mote]);
  ...
  /* Module SimpleSendP__2 */
  /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__busy[__nesc_mote] = FALSE;
  memset((void *)&/*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt[__nesc_mote], 0, sizeof /*TransportC.SimpleSendC.SimpleSendP*/SimpleSendP__2__pkt[__nesc_mote]);

  /* Module AMQueueEntryP__2 */

  /* Module PoolP__3 */
  memset((void *)&/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[__nesc_mote], 0, sizeof /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__free[__nesc_mote]);
  memset((void *)&/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__index[__nesc_mote], 0, sizeof /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__index[__nesc_mote]);
  memset((void *)&/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__queue[__nesc_mote], 0, sizeof /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__queue[__nesc_mote]);
  memset((void *)&/*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool[__nesc_mote], 0, sizeof /*TransportC.SimpleSendC.PoolC.PoolP*/PoolP__3__pool[__nesc_mote]);

  /* Module QueueC__3 */
  memset((void *)&/*TransportC.SimpleSendC.QueueC*/QueueC__3__queue[__nesc_mote], 0, sizeof /*TransportC.SimpleSendC.QueueC*/QueueC__3__queue[__nesc_mote]);
  /*TransportC.SimpleSendC.QueueC*/QueueC__3__head[__nesc_mote] = 0;
  /*TransportC.SimpleSendC.QueueC*/QueueC__3__size[__nesc_mote] = 0;
  ...
  /* Module ClientP */
  memset((void *)&ClientP__server[__nesc_mote], 0, sizeof ClientP__server[__nesc_mote]);
  memset((void *)&ClientP__client[__nesc_mote], 0, sizeof ClientP__client[__nesc_mote]);
  ClientP__numServers[__nesc_mote] = 0;
  ClientP__numClients[__nesc_mote] = 0;

  /* Module SimpleSendP__3 */
  /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__busy[__nesc_mote] = FALSE;
  memset((void *)&/*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt[__nesc_mote], 0, sizeof /*ClientC.SimpleSendC.SimpleSendP*/SimpleSendP__3__pkt[__nesc_mote]);

  /* Module AMQueueEntryP__3 */

  /* Module PoolP__4 */
  memset((void *)&/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[__nesc_mote], 0, sizeof /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__free[__nesc_mote]);
  memset((void *)&/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__index[__nesc_mote], 0, sizeof /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__index[__nesc_mote]);
  memset((void *)&/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__queue[__nesc_mote], 0, sizeof /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__queue[__nesc_mote]);
  memset((void *)&/*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool[__nesc_mote], 0, sizeof /*ClientC.SimpleSendC.PoolC.PoolP*/PoolP__4__pool[__nesc_mote]);

  /* Module QueueC__4 */
  memset((void *)&/*ClientC.SimpleSendC.QueueC*/QueueC__4__queue[__nesc_mote], 0, sizeof /*ClientC.SimpleSendC.QueueC*/QueueC__4__queue[__nesc_mote]);
  /*ClientC.SimpleSendC.QueueC*/QueueC__4__head[__nesc_mote] = 0;
  /*ClientC.SimpleSendC.QueueC*/QueueC__4__size[__nesc_mote] = 0;

  /* Module HashmapC__2 */
  /*ClientC.HashmapC*/HashmapC__2__HASH_MAX_SIZE[__nesc_mote] = 20;
  /*ClientC.HashmapC*/HashmapC__2__EMPTY_KEY[__nesc_mote] = 0;
  memset((void *)&/*ClientC.HashmapC*/HashmapC__2__map[__nesc_mote], 0, sizeof /*ClientC.HashmapC*/HashmapC__2__map[__nesc_mote]);
  memset((void *)&/*ClientC.HashmapC*/HashmapC__2__keys[__nesc_mote], 0, sizeof /*ClientC.HashmapC*/HashmapC__2__keys[__nesc_mote]);
  memset((void *)&/*ClientC.HashmapC*/HashmapC__2__numofVals[__nesc_mote], 0, sizeof /*ClientC.HashmapC*/HashmapC__2__numofVals[__nesc_mote]);

  /* Module ChatP */
  memset((void *)&ChatP__chatApp[__nesc_mote], 0, sizeof ChatP__chatApp[__nesc_mote]);
  ...
  /* Module PoolP__5 */
  memset((void *)&/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[__nesc_mote], 0, sizeof /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__free[__nesc_mote]);
  memset((void *)&/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__index[__nesc_mote], 0, sizeof /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__index[__nesc_mote]);
  memset((void *)&/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__queue[__nesc_mote], 0, sizeof /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__queue[__nesc_mote]);
  memset((void *)&/*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool[__nesc_mote], 0, sizeof /*ChatC.SimpleSendC.PoolC.PoolP*/PoolP__5__pool[__nesc_mote]);
